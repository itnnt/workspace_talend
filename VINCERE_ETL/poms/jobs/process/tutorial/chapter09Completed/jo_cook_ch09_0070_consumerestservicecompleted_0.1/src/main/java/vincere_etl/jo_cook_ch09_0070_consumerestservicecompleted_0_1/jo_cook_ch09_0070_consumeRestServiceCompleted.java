...
package vincere_etl.jo_cook_ch09_0070_consumerestservicecompleted_0_1;
...
/**
 * Job: jo_cook_ch09_0070_consumeRestServiceCompleted Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class jo_cook_ch09_0070_consumeRestServiceCompleted implements TalendJob {
	...
	private final String jobName = "jo_cook_ch09_0070_consumeRestServiceCompleted";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					jo_cook_ch09_0070_consumeRestServiceCompleted.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(jo_cook_ch09_0070_consumeRestServiceCompleted.this,
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_VINCERE_ETL_jo_cook_ch09_0070_consumeRestServiceCompleted = new byte[0];
		static byte[] commonByteArray_VINCERE_ETL_jo_cook_ch09_0070_consumeRestServiceCompleted = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_VINCERE_ETL_jo_cook_ch09_0070_consumeRestServiceCompleted.length) {
					if (length < 1024
							&& commonByteArray_VINCERE_ETL_jo_cook_ch09_0070_consumeRestServiceCompleted.length == 0) {
						commonByteArray_VINCERE_ETL_jo_cook_ch09_0070_consumeRestServiceCompleted = new byte[1024];
					} else {
						commonByteArray_VINCERE_ETL_jo_cook_ch09_0070_consumeRestServiceCompleted = new byte[2
								* length];
					}
				}
				dis.readFully(commonByteArray_VINCERE_ETL_jo_cook_ch09_0070_consumeRestServiceCompleted, 0, length);
				strReturn = new String(commonByteArray_VINCERE_ETL_jo_cook_ch09_0070_consumeRestServiceCompleted, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_VINCERE_ETL_jo_cook_ch09_0070_consumeRestServiceCompleted) {
...
// expected response body
				...
				try {
					...
					// set request path
					webClient_tRESTClient_1.path("maps/api/geocode/xml");
					...
					webClient_tRESTClient_1.query("address", "Trafalgar Square");

					webClient_tRESTClient_1.query("sensor", "false");
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final jo_cook_ch09_0070_consumeRestServiceCompleted jo_cook_ch09_0070_consumeRestServiceCompletedClass = new jo_cook_ch09_0070_consumeRestServiceCompleted();

		int exitCode = jo_cook_ch09_0070_consumeRestServiceCompletedClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = jo_cook_ch09_0070_consumeRestServiceCompleted.class.getClassLoader()
					.getResourceAsStream("vincere_etl/jo_cook_ch09_0070_consumerestservicecompleted_0_1/contexts/"
							+ contextStr + ".properties");
			if (inContext == null) {
				inContext = jo_cook_ch09_0070_consumeRestServiceCompleted.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : jo_cook_ch09_0070_consumeRestServiceCompleted");
		}
...
/************************************************************************************************
 * 51092 characters generated by Talend Open Studio for Data Integration on the
 * November 22, 2019 at 9:40:29 PM ICT
 ************************************************************************************************/