...
package vincere_etl.parent_0_1;
 ...
 * @status
 */
public class parent implements TalendJob {
	...
	private final String jobName = "parent";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(parent.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_VINCERE_ETL_parent = new byte[0];
		static byte[] commonByteArray_VINCERE_ETL_parent = new byte[0];

		public void readData(ObjectInputStream dis) {

			synchronized (commonByteArrayLock_VINCERE_ETL_parent) {
	...
	public void tLoop_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				for (int looptLoop_1 = 1; looptLoop_1 <= 5; looptLoop_1 = looptLoop_1 + 1) {
					...
					vincere_etl.child_0_1.child childJob_tRunJob_1 = new vincere_etl.child_0_1.child();
					// pass DataSources
	...
	public static void main(String[] args) {
		final parent parentClass = new parent();

		int exitCode = parentClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = parent.class.getClassLoader()
					.getResourceAsStream("vincere_etl/parent_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = parent.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : parent");
		}
...
/************************************************************************************************
 * 32717 characters generated by Talend Open Studio for Data Integration on the
 * November 22, 2019 at 10:10:51 PM ICT
 ************************************************************************************************/