...
public class TMysqlConnectionBeginJava
{
  ...
  protected final String TEXT_21 = " - Connection is set auto commit to '";
  ...
  protected final String TEXT_29 = " + \"?\" + \"rewriteBatchedStatements=true\";";
  protected final String TEXT_30 = NL + "\t\tString properties_";
  protected final String TEXT_31 = ";" + NL + "\t\tif (properties_";
  protected final String TEXT_32 = " == null || properties_";
  protected final String TEXT_33 = ".trim().length() == 0) {" + NL + "\t\t\tproperties_";
  protected final String TEXT_34 = " += \"rewriteBatchedStatements=true\";" + NL + "\t\t}else if (properties_";
  protected final String TEXT_35 = " != null && !properties_";
  protected final String TEXT_36 = ".contains(\"rewriteBatchedStatements\")) {" + NL + "\t\t\tproperties_";
  protected final String TEXT_37 = " += \"&rewriteBatchedStatements=true\";" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\tString url_";
  protected final String TEXT_38 = " + \"?\" + properties_";
  protected final String TEXT_39 = ";";
  protected final String TEXT_40 = NL + NL + "\t";
  protected final String TEXT_41 = NL + "\t\tString dbUser_";
  ...
  protected final String TEXT_52 = NL + "\tjava.sql.Connection conn_";
  ...
  protected final String TEXT_61 = NL + "\t\t\t\tfinal StringBuffer log4jSb_";
  protected final String TEXT_62 = " = new StringBuffer();" + NL + "\t\t\t";
  protected final String TEXT_63 = " - Retrieving the record \" + (nb_line_";
  protected final String TEXT_64 = ") + \".\");" + NL + "\t\t\t";
  protected final String TEXT_65 = " - Writing the record \" + nb_line_";
  protected final String TEXT_66 = " + \" to the file.\");" + NL + "\t\t\t";
  protected final String TEXT_67 = " - Processing the record \" + nb_line_";
  protected final String TEXT_68 = " + \".\");" + NL + "\t\t\t";
  protected final String TEXT_69 = " - Processed records count: \" + nb_line_";
  protected final String TEXT_70 = NL + "\t\t\t\tif(conn_";
  protected final String TEXT_71 = " != null) {" + NL + "\t\t\t\t\tif(conn_";
  protected final String TEXT_72 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_73 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_74 = " - Uses an existing connection ";
  protected final String TEXT_75 = ".\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_76 = NL + "\t\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_77 = " - Uses an existing connection. Connection URL: \" + conn_";
  protected final String TEXT_78 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t";
  ...
  protected final String TEXT_85 = ".rollback();" + NL + "\t\t\t";
  protected final String TEXT_86 = ".commit();" + NL + "\t\t\t";
  protected final String TEXT_87 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_88 = NL + "\t\t\t\tlog.";
  ...
  protected final String TEXT_95 = ".executeBatch();" + NL + "\t\t\t";
  protected final String TEXT_96 = NL + "\t\t\t\tint countSum_";
  protected final String TEXT_97 = " = 0;" + NL + "\t\t\t\tfor(int countEach_";
  protected final String TEXT_98 = ": pstmt_";
  protected final String TEXT_99 = ".executeBatch()) {" + NL + "\t\t\t\t\tcountSum_";
  protected final String TEXT_100 = " += (countEach_";
  protected final String TEXT_101 = " < 0 ? 0 : ";
  ...
  protected final String TEXT_105 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\tif (dataSources_";
  protected final String TEXT_106 = " == null) {";
  protected final String TEXT_107 = NL + "\t\t";
  protected final String TEXT_108 = NL + NL + "\t\tglobalMap.put(\"conn_";
  protected final String TEXT_109 = "\", conn_";
  protected final String TEXT_110 = NL + "\t} else {" + NL + "\t\tString dsAlias_";
  protected final String TEXT_111 = ";" + NL + "\t\tif (dataSources_";
  protected final String TEXT_112 = ".get(dsAlias_";
  protected final String TEXT_113 = ") == null) {" + NL + "   \t\t\tthrow new Exception(\"No DataSource with alias: \" + dsAlias_";
  protected final String TEXT_114 = " + \" available!\");" + NL + "      \t}" + NL + "\t\tconn_";
  protected final String TEXT_115 = " = dataSources_";
  protected final String TEXT_116 = ").getConnection();" + NL + "\t\tglobalMap.put(\"conn_";
  protected final String TEXT_117 = ");" + NL + "\t}";
  protected final String TEXT_118 = NL + "\tif (null != conn_";
  protected final String TEXT_119 = ") {" + NL + "\t\t";
  protected final String TEXT_120 = NL + "\t}";
  protected final String TEXT_121 = NL + NL + "\tglobalMap.put(\"conn_";
  protected final String TEXT_122 = "\",conn_";
  protected final String TEXT_123 = ");" + NL + "" + NL + "\tglobalMap.put(\"db_";
