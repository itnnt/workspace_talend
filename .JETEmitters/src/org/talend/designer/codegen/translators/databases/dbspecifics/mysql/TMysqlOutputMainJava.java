...
public class TMysqlOutputMainJava {
  ...
  protected final String TEXT_57 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_58 = ", \"";
  protected final String TEXT_59 = "\")";
  protected final String TEXT_60 = ".toUpperCase()";
  ...
  protected final String TEXT_70 = "+\"]\"+ \"[checktable]\" + \"[\" + ";
  protected final String TEXT_71 = " + \"]\";";
  protected final String TEXT_72 = NL + "                    // [%connection%][checktable][tableName]" + NL + "                    String keyCheckTable_";
  protected final String TEXT_73 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_74 = NL + NL + "                if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_75 = ")== null){//}" + NL + "" + NL + "                    synchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_76 = ")) {//}" + NL + "                        if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_77 = ")== null){//}";
  protected final String TEXT_78 = NL + "                                boolean whetherExist_";
  protected final String TEXT_79 = " = false;" + NL + "                                try (java.sql.Statement isExistStmt_";
  protected final String TEXT_80 = ".createStatement()) {" + NL + "                                    try {" + NL + "                                        isExistStmt_";
  protected final String TEXT_81 = ".execute(\"SELECT TOP 1 1 FROM [\" + tableName_";
  protected final String TEXT_82 = " + \"]\" );" + NL + "                                        whetherExist_";
  protected final String TEXT_83 = " = true;" + NL + "                                    } catch (java.lang.Exception e){" + NL + "                                        whetherExist_";
  protected final String TEXT_84 = " = false;" + NL + "                                    }" + NL + "                                }";
  ...
  protected final String TEXT_91 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                boolean whetherExist_";
  protected final String TEXT_92 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_96 = ", new String[]{\"TABLE\"})) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_97 = ".next()) {" + NL + "                                        whetherExist_";
  protected final String TEXT_98 = " = true;" + NL + "                                    }" + NL + "                                }" + NL;
  protected final String TEXT_99 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_100 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_101 = ".next()) {" + NL + "                                        String table_";
  protected final String TEXT_102 = " = rsTable_";
  protected final String TEXT_103 = ".getString(\"TABLE_NAME\");" + NL + "                                        String schema_";
  protected final String TEXT_104 = ".getString(\"TABLE_SCHEM\");" + NL + "                                        if(table_";
  protected final String TEXT_105 = ".equals";
  protected final String TEXT_106 = "IgnoreCase";
  ...
  protected final String TEXT_112 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_113 = "((";
  protected final String TEXT_114 = ")";
  protected final String TEXT_115 = ") || (dbschema_";
  protected final String TEXT_116 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_117 = ".equalsIgnoreCase(schema_";
  protected final String TEXT_118 = ")))) {" + NL + "                                            whetherExist_";
  protected final String TEXT_119 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    String defaultSchema_";
  protected final String TEXT_120 = " = \"public\";" + NL + "                                    if(dbschema_";
  protected final String TEXT_121 = " == null || dbschema_";
  protected final String TEXT_122 = ".trim().length() == 0) {" + NL + "                                        try(java.sql.Statement stmtSchema_";
  protected final String TEXT_123 = ".createStatement();" + NL + "                                            java.sql.ResultSet rsSchema_";
  protected final String TEXT_124 = " = stmtSchema_";
  protected final String TEXT_125 = ".executeQuery(\"select current_schema() \")) {" + NL + "                                            while(rsSchema_";
  protected final String TEXT_126 = ".next()){" + NL + "                                                defaultSchema_";
  protected final String TEXT_127 = " = rsSchema_";
  protected final String TEXT_128 = ".getString(\"current_schema\");" + NL + "                                            }" + NL + "                                        }" + NL + "                                    }" + NL + "                                    while(rsTable_";
  protected final String TEXT_129 = ") || ((dbschema_";
  protected final String TEXT_130 = " ==null || dbschema_";
  protected final String TEXT_131 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_132 = "(schema_";
  protected final String TEXT_133 = NL + "                                String tableForSearch_";
  protected final String TEXT_134 = " = ";
  protected final String TEXT_135 = ";" + NL + "                                if(tableForSearch_";
  protected final String TEXT_136 = " != null){" + NL + "                                    if(tableForSearch_";
  protected final String TEXT_137 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_138 = ".endsWith(\"\\\"\")){" + NL + "                                        tableForSearch_";
  protected final String TEXT_139 = " =  tableForSearch_";
  protected final String TEXT_140 = ".substring(1,tableForSearch_";
  protected final String TEXT_141 = ".length()-1);" + NL + "                                    }else{" + NL + "                                        tableForSearch_";
  protected final String TEXT_142 = ".toUpperCase();" + NL + "                                    }" + NL + "                                }" + NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_143 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_144 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_145 = ".getTables(null, conn_";
  protected final String TEXT_146 = ".getSchema(), tableForSearch_";
  protected final String TEXT_147 = ", new String[]{\"TABLE\"})) {" + NL + "                                       if(rsTable_";
  protected final String TEXT_148 = " = true;" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_149 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_150 = ", null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_151 = ".next()) {" + NL + "                                        if(rsTable_";
  protected final String TEXT_152 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  protected final String TEXT_153 = ")) {" + NL + "                                            whetherExist_";
  protected final String TEXT_154 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }" + NL + "                            " + NL + "                            ";
  protected final String TEXT_155 = ".getTables(";
  protected final String TEXT_156 = ", null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_157 = ".next()) {" + NL + "                                        String table_";
  protected final String TEXT_158 = ".getString(\"TABLE_NAME\");" + NL + "                                        if(table_";
  protected final String TEXT_159 = ".equalsIgnoreCase(";
  protected final String TEXT_160 = ")) {" + NL + "                                            whetherExist_";
  protected final String TEXT_161 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_162 = ".getString(\"TABLE_NAME\");" + NL + "                                        if(table_";
  ...
  protected final String TEXT_169 = NL + "                                if(whetherExist_";
  protected final String TEXT_170 = ") {" + NL + "                                    try (java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_175 = NL + "                                }" + NL + "                                try(java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_182 = NL + "                              stmtClear_";
  protected final String TEXT_183 = NL + "                stmtClear_";
  protected final String TEXT_184 = ".executeUpdate(\"";
  protected final String TEXT_185 = "\");";
  protected final String TEXT_186 = NL + "            int rsTruncCountNumber_";
  protected final String TEXT_187 = " = 0;" + NL + "            try(java.sql.Statement stmtTruncCount_";
  protected final String TEXT_188 = NL + "                              stmtTruncCount_";
  protected final String TEXT_189 = NL + "                try (java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_190 = " = stmtTruncCount_";
  protected final String TEXT_191 = ".executeQuery(\"";
  protected final String TEXT_192 = "\")) {" + NL + "                    if(rsTruncCount_";
  protected final String TEXT_193 = ".next()) {" + NL + "                        rsTruncCountNumber_";
  protected final String TEXT_194 = " = rsTruncCount_";
  protected final String TEXT_195 = ".getInt(1);" + NL + "                    }" + NL + "                }" + NL + "            }" + NL + "            try (java.sql.Statement stmtTrunc_";
  protected final String TEXT_196 = NL + "                              stmtTrunc_";
  protected final String TEXT_197 = NL + "                conn_";
  protected final String TEXT_198 = NL + "                stmtTrunc_";
  protected final String TEXT_199 = NL + "                    if(!conn_";
  protected final String TEXT_200 = ".getAutoCommit()){" + NL + "                        conn_";
  protected final String TEXT_201 = ".commit();" + NL + "                    }";
  protected final String TEXT_202 = NL + "                deletedCount_";
  protected final String TEXT_203 = " += rsTruncCountNumber_";
  protected final String TEXT_204 = ";" + NL + "            }";
  protected final String TEXT_205 = NL + "            try (java.sql.Statement stmtTruncCount_";
  protected final String TEXT_206 = ".createStatement();" + NL + "                java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_207 = "\");" + NL + "                java.sql.Statement stmtTrunc_";
  ...
  protected final String TEXT_211 = ".getInt(1);" + NL + "                }" + NL + "            }";
  protected final String TEXT_212 = NL + "            StringBuffer duplidateClause_";
  protected final String TEXT_213 = " = new StringBuffer(\" ON DUPLICATE KEY UPDATE \");";
  protected final String TEXT_214 = NL + "                        duplidateClause_";
  protected final String TEXT_215 = ".append(\",\");";
  protected final String TEXT_216 = ".append (\"`\" +  ";
  protected final String TEXT_217 = " + \"`\");" + NL + "                        duplidateClause_";
  protected final String TEXT_218 = ".append (\"=\");" + NL + "                        duplidateClause_";
  protected final String TEXT_219 = ".append (";
  protected final String TEXT_220 = ";";
  protected final String TEXT_221 = NL + "                insert_";
  protected final String TEXT_222 = " +=  duplidateClause_";
  ...
  protected final String TEXT_235 = ");" + NL + "                        resourceMap.put(\"pstmt_";
  protected final String TEXT_236 = "\", pstmt_";
  protected final String TEXT_237 = " = null;" + NL + "                        // [%connection%][psmt][tableName]" + NL + "                        String keyPsmt_";
  protected final String TEXT_238 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_239 = " + \"]\";" + NL + "                        if(GlobalResource.resourceMap.get(keyPsmt_";
  protected final String TEXT_240 = ")== null){" + NL + "                            pstmt_";
  protected final String TEXT_241 = ");" + NL + "                            resourceMap.put(\"pstmt_";
  protected final String TEXT_242 = ");" + NL + "                            GlobalResource.resourceMap.put(keyPsmt_";
  protected final String TEXT_243 = ", pstmt_";
  protected final String TEXT_244 = ");" + NL + "                        }else{" + NL + "                            pstmt_";
  protected final String TEXT_245 = " = (java.sql.PreparedStatement)GlobalResource.resourceMap.get(keyPsmt_";
  protected final String TEXT_246 = ");" + NL + "                        }";
  protected final String TEXT_247 = NL + "                ////////////////////////////////////////////////////////////////////////////////////////////" + NL + "" + NL + "" + NL + "                StringBuilder extendInsertValueStmt_";
  protected final String TEXT_248 = " = new StringBuilder();" + NL + "                for(int i=0;i < ";
  protected final String TEXT_249 = ";i++){";
  protected final String TEXT_250 = NL + "                    extendInsertValueStmt_";
  protected final String TEXT_251 = ".append(\"(";
  protected final String TEXT_252 = ",\"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_253 = ")+\")\");";
  protected final String TEXT_254 = NL + "                if (i!=";
  protected final String TEXT_255 = "-1) extendInsertValueStmt_";
  protected final String TEXT_256 = ".append(\",\");" + NL + "                }";
  protected final String TEXT_257 = NL + "                        insert_";
  protected final String TEXT_258 = " = \"INSERT INTO `\" + ";
  protected final String TEXT_259 = " + \"` (\"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_260 = "\", ";
  protected final String TEXT_261 = ")+\") VALUES \" + extendInsertValueStmt_";
  protected final String TEXT_262 = "    " + NL + "                    pstmt_";
  protected final String TEXT_263 = " =  conn_";
  protected final String TEXT_264 = ");" + NL + "                    resourceMap.put(\"pstmt_";
  protected final String TEXT_265 = NL + NL + "                        insertColName";
  protected final String TEXT_266 = " = \"";
  protected final String TEXT_267 = ", \"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_268 = "\");" + NL + "                        insertColValue";
  protected final String TEXT_269 = ", \"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_270 = NL + "                        insertColName";
  protected final String TEXT_271 = " = DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_272 = " = DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_273 = NL + "                rowCount";
  protected final String TEXT_274 = " = 0;";
  protected final String TEXT_275 = NL + "                int rowCount";
  protected final String TEXT_276 = NL + "                        batchSize_";
  protected final String TEXT_277 = ";" + NL + "                        batchSizeCounter_";
  protected final String TEXT_278 = "=0;";
  protected final String TEXT_279 = NL + "                        int batchSize_";
  protected final String TEXT_280 = ";" + NL + "                        int batchSizeCounter_";
  ...
  protected final String TEXT_284 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_285 = " = new StringBuffer(update_";
  protected final String TEXT_286 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_287 = ".insert(update_";
  protected final String TEXT_288 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_289 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_290 = " =updateStringBuffer_";
  protected final String TEXT_291 = NL + "        pstmt_";
  protected final String TEXT_292 = ".prepareStatement(update_";
  protected final String TEXT_293 = ");" + NL + "        resourceMap.put(\"pstmt_";
  protected final String TEXT_294 = ".prepareStatement(\"SELECT COUNT(1) FROM `\" + ";
  protected final String TEXT_295 = " + \"` WHERE \" + DynamicUtils.getUpdateWhere(";
  protected final String TEXT_296 = "\", new StringBuilder(\"";
  protected final String TEXT_297 = "\"), ";
  protected final String TEXT_298 = "));//String insert_";
  protected final String TEXT_299 = " + \"` (";
  protected final String TEXT_300 = ") VALUES (";
  protected final String TEXT_301 = ")\";" + NL + "        resourceMap.put(\"pstmt_";
  protected final String TEXT_302 = "    " + NL + "        pstmtInsert_";
  protected final String TEXT_303 = ");" + NL + "        resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_304 = "\", pstmtInsert_";
  protected final String TEXT_305 = NL + "        pstmtUpdate_";
  protected final String TEXT_306 = ");" + NL + "        resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_307 = "\", pstmtUpdate_";
  protected final String TEXT_308 = NL + "            String delete_";
  protected final String TEXT_309 = " = \"DELETE FROM `\" + ";
  protected final String TEXT_310 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_311 = " = new StringBuffer(delete_";
  protected final String TEXT_312 = ");" + NL + "    deleteStringBuffer_";
  protected final String TEXT_313 = ".insert(delete_";
  protected final String TEXT_314 = ".indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_315 = "  + \" \" );" + NL + "    delete_";
  protected final String TEXT_316 = " =deleteStringBuffer_";
  protected final String TEXT_317 = ".toString();  ";
  protected final String TEXT_318 = NL + "        pstmt_";
  protected final String TEXT_319 = ".prepareStatement(delete_";
  protected final String TEXT_320 = ".prepareStatement(replace_";
  protected final String TEXT_321 = ";" + NL + "            insertIgnore_";
  protected final String TEXT_322 = " = insertIgnore_";
  protected final String TEXT_323 = " + \" ON DUPLICATE KEY UPDATE \" + DynamicUtils.getUpdateSet(";
  protected final String TEXT_324 = ".prepareStatement(insertIgnore_";
  protected final String TEXT_325 = "    " + NL + "        pstmt_";
  protected final String TEXT_326 = NL + "\t\t \tinsertSQLSplits_";
  protected final String TEXT_327 = " = insert_";
  protected final String TEXT_328 = ".split(\"\\\\?\");";
  protected final String TEXT_329 = NL + "\t\t\tupdate_";
  protected final String TEXT_330 = " += \" \";" + NL + "\t    \tupdateSQLSplits_";
  protected final String TEXT_331 = " = update_";
  protected final String TEXT_332 = " += \" \";" + NL + "\t\t\tupdateSQLSplits_";
  protected final String TEXT_333 = ".split(\"\\\\?\");" + NL + "\t\t\tinsertSQLSplits_";
  protected final String TEXT_334 = NL + "\t\t\tdelete_";
  protected final String TEXT_335 = " += \" \";" + NL + "\t\t   \tdeleteSQLSplits_";
  protected final String TEXT_336 = " = delete_";
  protected final String TEXT_337 = NL + "\t\t\treplace_";
  protected final String TEXT_338 = " += \" \";" + NL + "\t\t\treplaceSQLSplits_";
  protected final String TEXT_339 = " = replace_";
  protected final String TEXT_340 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_341 = " += \" \";" + NL + "\t\t\tinsertIgnoreSQLSplits_";
  protected final String TEXT_342 = NL + "        }";
  protected final String TEXT_343 = NL + "                if(";
  protected final String TEXT_344 = "==null){";
  protected final String TEXT_345 = ".setNull(counter";
  protected final String TEXT_346 = ",java.sql.Types.CHAR);";
  protected final String TEXT_347 = ",java.sql.Types.DATE);";
  protected final String TEXT_348 = ",java.sql.Types.ARRAY);";
  protected final String TEXT_349 = ",java.sql.Types.INTEGER);";
  protected final String TEXT_350 = ",java.sql.Types.VARCHAR);";
  protected final String TEXT_351 = ",java.sql.Types.OTHER);";
  protected final String TEXT_352 = ",java.sql.Types.BOOLEAN);";
  protected final String TEXT_353 = ",java.sql.Types.DOUBLE);";
  protected final String TEXT_354 = ",java.sql.Types.FLOAT);";
  protected final String TEXT_355 = NL + "                }else{";
  protected final String TEXT_356 = NL + "                    if((\"null\").equals(String.valueOf(";
  protected final String TEXT_357 = ").toLowerCase())){";
  protected final String TEXT_358 = ",java.sql.Types.CHAR);" + NL + "" + NL + "                }else if(";
  protected final String TEXT_359 = " == '\\0'){" + NL;
  protected final String TEXT_360 = ".setString(counter";
  protected final String TEXT_361 = ",\"\");" + NL + "" + NL + "                }else{" + NL;
  protected final String TEXT_362 = ",String.valueOf(";
  protected final String TEXT_363 = "));" + NL + "                }";
  protected final String TEXT_364 = "!=null){" + NL + "                    // timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL" + NL + "                    date_";
  protected final String TEXT_365 = ".getTime();" + NL + "                    if (date_";
  protected final String TEXT_366 = " < year1_";
  protected final String TEXT_367 = " || date_";
  protected final String TEXT_368 = " >= year10000_";
  protected final String TEXT_369 = ") {";
  protected final String TEXT_370 = ", \"0000-00-00 00:00:00\");" + NL + "                    } else {";
  protected final String TEXT_371 = ".setTimestamp(counter";
  protected final String TEXT_372 = ", new java.sql.Timestamp(date_";
  protected final String TEXT_373 = "));" + NL + "                    }" + NL + "                }else{" + NL;
  protected final String TEXT_374 = ",java.sql.Types.DATE);" + NL + "" + NL + "                }";
  protected final String TEXT_375 = ".set";
  protected final String TEXT_376 = "(counter";
  protected final String TEXT_377 = ",";
  protected final String TEXT_378 = NL + NL + "                }" + NL;
  protected final String TEXT_379 = NL + "        query_";
  protected final String TEXT_380 = " = new StringBuffer(\"\");";
  protected final String TEXT_381 = NL + "                commitEvery_";
  protected final String TEXT_382 = " = buffersSize_";
  protected final String TEXT_383 = NL + "                    batchSize_";
  protected final String TEXT_384 = NL + "        whetherReject_";
  protected final String TEXT_385 = " = false;";
  protected final String TEXT_386 = NL + "                        int counter";
  protected final String TEXT_387 = " = rowCount";
  protected final String TEXT_388 = " * ";
  protected final String TEXT_389 = " + 1;";
  protected final String TEXT_390 = NL + "                            counter";
  protected final String TEXT_391 = "++;";
  protected final String TEXT_392 = NL + "                            int count_dyn_";
  protected final String TEXT_393 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_394 = ", counter";
  protected final String TEXT_395 = "-1, \"";
  protected final String TEXT_396 = "\");" + NL + "                            counter";
  protected final String TEXT_397 = "+=count_dyn_";
  protected final String TEXT_398 = NL + NL + "                    exInsertColValue";
  protected final String TEXT_399 = " = new BufferLine_";
  protected final String TEXT_400 = NL + "                                ,";
  protected final String TEXT_401 = NL + "                    , ";
  protected final String TEXT_402 = NL + "                    );" + NL + "" + NL + "                    exInsertColValueList";
  protected final String TEXT_403 = ".add(exInsertColValue";
  protected final String TEXT_404 = ");" + NL + "" + NL + "                    rowCount";
  protected final String TEXT_405 = NL + "                nb_line_";
  protected final String TEXT_406 = NL + "                    if(rowCount";
  protected final String TEXT_407 = " == ";
  protected final String TEXT_408 = "){" + NL + "                        try{" + NL + "                            insertedCount_";
  protected final String TEXT_409 = " = insertedCount_";
  protected final String TEXT_410 = " + pstmt_";
  protected final String TEXT_411 = ".executeUpdate();" + NL + "                        }catch(java.lang.Exception e){";
  protected final String TEXT_412 = NL + "                             throw e;";
  protected final String TEXT_413 = NL + "                             System.err.println(e.getMessage());";
  protected final String TEXT_414 = NL + "                        }" + NL + "                        exInsertColValueList";
  protected final String TEXT_415 = ".clear();" + NL + "                        rowCount";
  protected final String TEXT_416 = " = 0;" + NL + "                        counter";
  protected final String TEXT_417 = "=1;" + NL + "                    }";
  protected final String TEXT_418 = NL + "                                query_";
  protected final String TEXT_419 = NL + "                            routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_420 = ", ";
  protected final String TEXT_421 = ",insertSQLSplits_";
  protected final String TEXT_422 = NL + "                            DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_423 = NL + "                        globalMap.put(\"";
  protected final String TEXT_424 = "_QUERY\", query_";
  protected final String TEXT_425 = ".toString().trim());";
  protected final String TEXT_426 = NL + "                    pstmt_";
  protected final String TEXT_427 = ".addBatch();" + NL + "                    nb_line_";
  protected final String TEXT_428 = "++;" + NL;
  protected final String TEXT_429 = NL + "                      batchSizeCounter_";
  protected final String TEXT_430 = NL + "                    try {" + NL + "                        nb_line_";
  protected final String TEXT_431 = "++;" + NL + "                        insertedCount_";
  ...
  protected final String TEXT_440 = NL + "                                rejectedCount_";
  protected final String TEXT_441 = " =  rejectedCount_";
  protected final String TEXT_442 = "+ 1;";
  protected final String TEXT_443 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_444 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  ...
  protected final String TEXT_449 = NL + "                        DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_450 = NL + "                    globalMap.put(\"";
  protected final String TEXT_451 = NL + "                try {" + NL + "                    nb_line_";
  protected final String TEXT_452 = "++;" + NL + "                    insertedCount_";
  protected final String TEXT_453 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_454 = NL + "                        throw(e);";
  protected final String TEXT_455 = NL + "                            rejectedCount_";
  protected final String TEXT_456 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_457 = NL + "                }";
  protected final String TEXT_458 = NL + "                        query_";
  protected final String TEXT_459 = ",updateSQLSplits_";
  protected final String TEXT_460 = NL + NL + "                int count_";
  protected final String TEXT_461 = "\", true);";
  protected final String TEXT_462 = NL + "                routines.system.DynamicUtils.insertKeyInWhereClause(";
  protected final String TEXT_463 = ", (count_";
  ...
  protected final String TEXT_470 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_471 = "++;" + NL + "                updatedCount_";
  protected final String TEXT_472 = " = updatedCount_";
  ...
  protected final String TEXT_476 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_477 = NL + "            }";
  protected final String TEXT_478 = NL + "                    DynamicUtils.insertKeyInWhereClause(";
  protected final String TEXT_479 = NL + "            int checkCount_";
  protected final String TEXT_480 = " = -1;" + NL + "            try (java.sql.ResultSet rs_";
  protected final String TEXT_481 = " = pstmt_";
  protected final String TEXT_482 = ".executeQuery()) {" + NL + "                while(rs_";
  protected final String TEXT_483 = ".next()) {" + NL + "                    checkCount_";
  protected final String TEXT_484 = " = rs_";
  protected final String TEXT_485 = ".getInt(1);" + NL + "                }" + NL + "            }" + NL + "            if(checkCount_";
  protected final String TEXT_486 = " > 0) {";
  protected final String TEXT_487 = NL + "                        routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_488 = NL + "                    int count_";
  protected final String TEXT_489 = ", pstmtUpdate_";
  protected final String TEXT_490 = NL + "                                    query_";
  protected final String TEXT_491 = NL + "                    routines.system.DynamicUtils.insertKeyInWhereClause(";
  protected final String TEXT_492 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_493 = " + pstmtUpdate_";
  protected final String TEXT_494 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_495 = NL + "                        nb_line_";
  protected final String TEXT_496 = NL + "                }" + NL + "            } else {";
  protected final String TEXT_497 = NL + "                    DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_498 = ", pstmtInsert_";
  protected final String TEXT_499 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_500 = " + pstmtInsert_";
  protected final String TEXT_501 = NL + "                }" + NL + "            }";
  protected final String TEXT_502 = NL + "            int updateFlag_";
  protected final String TEXT_503 = NL + "                int count_";
  protected final String TEXT_504 = NL + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_505 = "=pstmtUpdate_";
  protected final String TEXT_506 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_507 = "+updateFlag_";
  protected final String TEXT_508 = ";" + NL + "" + NL + "            if(updateFlag_";
  protected final String TEXT_509 = " == 0) {" + NL;
  protected final String TEXT_510 = NL + "                query_";
  protected final String TEXT_511 = NL + "                    insertedCount_";
  protected final String TEXT_512 = NL + "                }else{" + NL + "                    nb_line_";
  protected final String TEXT_513 = NL + "             }" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_514 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_515 = " = deletedCount_";
  protected final String TEXT_516 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_517 = NL + "                    nb_line_";
  protected final String TEXT_518 = ";" + NL;
  protected final String TEXT_519 = NL + "                DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_520 = NL + "            int replaceCount_";
  protected final String TEXT_521 = " = 0;" + NL + "            try {" + NL + "                replaceCount_";
  protected final String TEXT_522 = NL + "            }" + NL + "            if(replaceCount_";
  protected final String TEXT_523 = " == 1) {" + NL + "                insertedCount_";
  protected final String TEXT_524 = " += replaceCount_";
  protected final String TEXT_525 = ";" + NL + "            } else {" + NL + "                insertedCount_";
  protected final String TEXT_526 = " += 1;" + NL + "                deletedCount_";
  protected final String TEXT_527 = " - 1;" + NL + "            }";
  protected final String TEXT_528 = " = DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_529 = NL + "            int count_on_duplicate_key_";
  protected final String TEXT_530 = " = 0;" + NL + "            try {" + NL + "                count_on_duplicate_key_";
  protected final String TEXT_531 = NL + "            }" + NL + "            if(count_on_duplicate_key_";
  protected final String TEXT_532 = " += count_on_duplicate_key_";
  protected final String TEXT_533 = " += 1;" + NL + "                updatedCount_";
  protected final String TEXT_534 = NL + "            if(!whetherReject_";
  protected final String TEXT_535 = NL + "                if ( batchSize_";
  protected final String TEXT_536 = " <= batchSizeCounter_";
  protected final String TEXT_537 = NL + "                try {" + NL + "                        int countSum_";
  protected final String TEXT_538 = NL + "                        for(int countEach_";
  protected final String TEXT_539 = ": pstmt_";
  protected final String TEXT_540 = ".executeBatch()) {" + NL + "                            countSum_";
  protected final String TEXT_541 = " += (countEach_";
  protected final String TEXT_542 = " == java.sql.Statement.EXECUTE_FAILED ? 0 : 1);" + NL + "                        }";
  protected final String TEXT_543 = NL + "                        insertedCount_";
  protected final String TEXT_544 = " += countSum_";
  protected final String TEXT_545 = NL + "                }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_546 = NL + "                    int countSum_";
  protected final String TEXT_547 = " = 0;" + NL + "                    for(int countEach_";
  protected final String TEXT_548 = ": e.getUpdateCounts()) {" + NL + "                        countSum_";
  protected final String TEXT_549 = " < 0 ? 0 : countEach_";
  protected final String TEXT_550 = ");" + NL + "                    }";
  protected final String TEXT_551 = NL + "                    System.err.println(e.getMessage());";
  protected final String TEXT_552 = NL + NL + "                batchSizeCounter_";
  protected final String TEXT_553 = " = 0;" + NL + "            }";
  protected final String TEXT_554 = NL + "                        updatedCount_";
  protected final String TEXT_555 = NL + "                        deletedCount_";
  protected final String TEXT_556 = NL + "                        batchSizeCounter_";
  protected final String TEXT_557 = " = 0;" + NL + "                }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_558 = NL + "                    updatedCount_";
  protected final String TEXT_559 = NL + "                    deletedCount_";
  protected final String TEXT_560 = NL + NL + NL + NL + "                }";
  protected final String TEXT_561 = NL + "                commitCounter_";
  protected final String TEXT_562 = "++;" + NL + "" + NL + "                if(commitEvery_";
  protected final String TEXT_563 = " <= commitCounter_";
  protected final String TEXT_564 = ") {" + NL;
  protected final String TEXT_565 = " < 0 ? 0 : ";
  protected final String TEXT_566 = NL + NL + "                }";
  protected final String TEXT_567 = NL + "                    conn_";
  protected final String TEXT_568 = NL + "                    commitCounter_";
  protected final String TEXT_569 = "=0;" + NL + "" + NL + "                }" + NL;
