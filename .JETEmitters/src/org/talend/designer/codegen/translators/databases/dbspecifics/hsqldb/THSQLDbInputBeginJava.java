...
public class THSQLDbInputBeginJava
{
  ...
  protected final String TEXT_133 = " = \"jdbc:hsqldb:hsqls://\" + ";
  protected final String TEXT_134 = " + \":\" + ";
  protected final String TEXT_135 = " + \"/\" + ";
  protected final String TEXT_136 = " = \"jdbc:hsqldb:hsql://\" + ";
  protected final String TEXT_137 = " = \"jdbc:hsqldb:https://\" + ";
  protected final String TEXT_138 = " = \"jdbc:hsqldb:http://\" + ";
  protected final String TEXT_139 = NL + "\t\t        url_";
  protected final String TEXT_140 = " = \"jdbc:hsqldb:file:\" + ";
  protected final String TEXT_141 = NL + "\t\t\t\turl_";
  protected final String TEXT_142 = " = \"jdbc:hsqldb:mem:\" + ";
  protected final String TEXT_143 = " ;";
  protected final String TEXT_144 = " += \";\" + ";
  protected final String TEXT_145 = NL + "    " + NL + "\t";
  protected final String TEXT_146 = NL + "\t\t    int nb_line_";
  protected final String TEXT_147 = " = 0;" + NL + "\t\t    java.sql.Connection conn_";
  protected final String TEXT_148 = NL + "\t\t        conn_";
  protected final String TEXT_149 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_150 = "\");";
  protected final String TEXT_151 = NL + "             boolean currentAutoCommitMode";
  protected final String TEXT_152 = " =  conn_";
  protected final String TEXT_153 = ".getAutoCommit();" + NL + "             conn_";
  protected final String TEXT_154 = ".setAutoCommit(true);" + NL + "             try{";
  protected final String TEXT_155 = NL + "                           try{" + NL + "                               conn_";
  protected final String TEXT_156 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON \" + ";
  protected final String TEXT_157 = ");" + NL + "                           }catch(Exception e){" + NL + "                                 System.err.println(e.getMessage());" + NL + "                           }";
  protected final String TEXT_158 = NL + "                 conn_";
  protected final String TEXT_159 = ".createStatement().execute(" + NL + "              \"SET QUERY_BAND='\" +";
  protected final String TEXT_160 = NL + "               ";
  protected final String TEXT_161 = " + \"=\" + ";
  protected final String TEXT_162 = " + \";\" +";
  protected final String TEXT_163 = " \"' FOR SESSION\"" + NL + "           );" + NL + "              }catch(Exception e){" + NL + "               System.err.println(e.getMessage());" + NL + "      }" + NL + "      conn_";
  protected final String TEXT_164 = ".setAutoCommit(currentAutoCommitMode";
  protected final String TEXT_165 = NL + "\t\t    ";
  protected final String TEXT_166 = NL + NL + "\t\t    String dbquery_";
  protected final String TEXT_167 = ";" + NL + "\t\t\t";
  protected final String TEXT_168 = NL + "                log.debug(\"";
  protected final String TEXT_169 = " - Executing the query: '\"+dbquery_";
  protected final String TEXT_170 = "+\"'.\");" + NL + "\t\t\t";
  protected final String TEXT_171 = NL;
  protected final String TEXT_172 = NL + "            \tglobalMap.put(\"";
  protected final String TEXT_173 = "_QUERY\",dbquery_";
  protected final String TEXT_174 = NL + "\t\t    java.sql.ResultSet rs_";
  protected final String TEXT_175 = " = null;" + NL + "" + NL + "\t\t    try {" + NL + "\t\t    \trs_";
  protected final String TEXT_176 = " = stmt_";
  protected final String TEXT_177 = ".executeQuery(dbquery_";
  protected final String TEXT_178 = ");" + NL + "\t\t    \tjava.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_179 = ".getMetaData();" + NL + "\t\t    \tint colQtyInRs_";
  protected final String TEXT_180 = " = rsmd_";
  protected final String TEXT_181 = ".getColumnCount();" + NL;
  protected final String TEXT_182 = NL + "\t\t    routines.system.Dynamic dcg_";
  protected final String TEXT_183 = " =  new routines.system.Dynamic();" + NL + "\t\t    dcg_";
  protected final String TEXT_184 = ".setDbmsId(\"";
  protected final String TEXT_185 = "\");" + NL + "\t\t    List<String> listSchema_";
  protected final String TEXT_186 = "=new java.util.ArrayList<String>();" + NL + "\t\t    ";
  protected final String TEXT_187 = NL + "\t\t    \t    listSchema_";
  protected final String TEXT_188 = ".add(\"";
  protected final String TEXT_189 = "\");" + NL + "\t    \t    ";
  protected final String TEXT_190 = NL + NL + "\t\t\tint fixedColumnCount_";
  ...
  protected final String TEXT_196 = ".getColumnLabel(i).toUpperCase()) )) {" + NL + "                \troutines.system.DynamicMetadata dcm_";
  protected final String TEXT_197 = "=new routines.system.DynamicMetadata();" + NL + "                \tdcm_";
  protected final String TEXT_198 = ".setName(rsmd_";
  protected final String TEXT_199 = ".getColumnLabel(i));" + NL + "                \tdcm_";
  ...
  protected final String TEXT_208 = ".getColumnTypeName(i));" + NL + "                \tdcm_";
  protected final String TEXT_209 = ".setDbTypeId(rsmd_";
  protected final String TEXT_210 = ".getColumnType(i));";
  protected final String TEXT_211 = NL + "                \tdcm_";
  protected final String TEXT_212 = ".setFormat(";
  protected final String TEXT_213 = NL + "\t\t\tif(\"LONG\".equals(rsmd_";
  protected final String TEXT_214 = ".getColumnTypeName(i).toUpperCase())) {" + NL + "\t\t\t\tString length = MetadataTalendType.getDefaultDBTypes(\"oracle_id\", \"LONG\", MetadataTalendType.DEFAULT_LENGTH);" + NL + "\t\t\t\tif(length!=null && !(\"\".equals(length))) {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_215 = ".setLength(Integer.parseInt(length));" + NL + "\t\t\t\t} else {" + NL + "\t\t\t\t\tdcm_";
  protected final String TEXT_216 = ".setLength(rsmd_";
  protected final String TEXT_217 = ".getPrecision(i));" + NL + "\t\t\t\t}" + NL + "\t\t\t} else {" + NL + "\t\t\t\tdcm_";
  protected final String TEXT_218 = ".getPrecision(i));" + NL + "\t\t\t}";
  protected final String TEXT_219 = NL + "\t\t\tdcm_";
  protected final String TEXT_220 = ".getPrecision(i));";
  protected final String TEXT_221 = ".setPrecision(rsmd_";
  protected final String TEXT_222 = ".getScale(i));" + NL + "                \tdcm_";
  protected final String TEXT_223 = ".setNullable(rsmd_";
  protected final String TEXT_224 = ".isNullable(i) == 0 ? false : true);" + NL + "                \tdcm_";
  protected final String TEXT_225 = ".setKey(false);" + NL + "                \tdcm_";
  protected final String TEXT_226 = ".setSourceType(DynamicMetadata.sourceTypes.database);" + NL + "                \tdcm_";
  protected final String TEXT_227 = ".setColumnPosition(i);" + NL + "                \tdcg_";
  protected final String TEXT_228 = ".metadatas.add(dcm_";
  protected final String TEXT_229 = ");" + NL + "                }" + NL + "            }";
  protected final String TEXT_230 = NL + "\t\t    String tmpContent_";
  protected final String TEXT_231 = " = null;" + NL + "\t\t    ";
  protected final String TEXT_232 = NL + "\t\t    \tint column_index_";
  protected final String TEXT_233 = " =1;" + NL + "\t\t    ";
  protected final String TEXT_234 = NL + "\t\t    \tlog.debug(\"";
  protected final String TEXT_235 = " - Retrieving records from the database.\");" + NL + "\t\t    ";
  protected final String TEXT_236 = NL + "\t\t    while (rs_";
  protected final String TEXT_237 = ".next()) {" + NL + "\t\t        nb_line_";
  protected final String TEXT_238 = "++;" + NL + "\t\t        ";
  protected final String TEXT_239 = NL + "\t\t\t\t\t\t\t\t\tcolumn_index_";
  ...
  protected final String TEXT_247 = ";" + NL + "\t\t\t\t\t\t\t} else {";
  protected final String TEXT_248 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_249 = NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_250 = NL + "\t\t                            ";
  protected final String TEXT_251 = " = (List)rs_";
  protected final String TEXT_252 = ".getObject(";
  protected final String TEXT_253 = NL + "\t                         \t\t";
  protected final String TEXT_254 = NL + "                                    oracle.sql.STRUCT jGeomStruct = (oracle.sql.STRUCT) rs_";
  protected final String TEXT_255 = ");" + NL + "                                    if (jGeomStruct != null) {" + NL + "                                    oracle.spatial.geometry.JGeometry jGeom = oracle.spatial.geometry.JGeometry.load(jGeomStruct);" + NL + "                                    oracle.spatial.util.WKT wkt = new oracle.spatial.util.WKT();" + NL + "                                    String wktValue = new String(wkt.fromJGeometry(jGeom));" + NL;
  protected final String TEXT_256 = NL + "                                    ";
  protected final String TEXT_257 = " = new Geometry(wktValue);" + NL + "                                    } else {";
  ...
  protected final String TEXT_263 = ".setEPSG(";
  protected final String TEXT_264 = ");" + NL + "                                        }";
  protected final String TEXT_265 = NL + "                                  ";
  protected final String TEXT_266 = "=dcg_";
  protected final String TEXT_267 = NL + "\t\t\t\t\t\t\t\t\t\tList<String> list_";
  protected final String TEXT_268 = " = new java.util.ArrayList<String>();" + NL + "\t\t\t\t\t    \t\t\t\tfor(int i_";
  protected final String TEXT_269 = "; i_";
  protected final String TEXT_270 = "  <= rsmd_";
  protected final String TEXT_271 = ".getColumnCount(); i_";
  protected final String TEXT_272 = " ++){" + NL + "\t\t\t\t\t    \t\t\t\t\t";
  protected final String TEXT_273 = NL + "\t\t\t\t\t\t \t\t\t\t\tif (\"NTEXT\".equals(rsmd_";
  protected final String TEXT_274 = ".getColumnTypeName(i_";
  protected final String TEXT_275 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.ClobImpl clob_";
  protected final String TEXT_276 = " = (net.sourceforge.jtds.jdbc.ClobImpl) rs_";
  protected final String TEXT_277 = ".getClob(i_";
  protected final String TEXT_278 = ");" + NL + "\t\t\t\t\t\t\t\t\t\t\t\tif(clob_";
  protected final String TEXT_279 = " !=null){" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tnet.sourceforge.jtds.jdbc.TalendNTextImpl tNTextImpl_";
  protected final String TEXT_280 = " = new net.sourceforge.jtds.jdbc.TalendNTextImpl(clob_";
  protected final String TEXT_281 = ");" + NL + "\t\t\t\t\t\t\t  \t\t\t\t\t\tlist_";
  protected final String TEXT_282 = ".add(tNTextImpl_";
  protected final String TEXT_283 = ".getValue());" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t\tlist_";
  protected final String TEXT_284 = ".add(null);" + NL + "\t\t\t\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_285 = " " + NL + "\t\t\t\t\t\t   \t\t\t\t\tif(\"NTEXT\".equals(rsmd_";
  protected final String TEXT_286 = " ).toUpperCase())) {" + NL + "\t\t\t\t\t\t   \t\t\t\t\t\tlist_";
  protected final String TEXT_287 = ".add(rs_";
  protected final String TEXT_288 = ".getString(i_";
  protected final String TEXT_289 = "));" + NL + "\t\t\t\t\t\t   \t\t\t\t\t}" + NL + "\t\t\t\t\t\t   \t\t\t\t\t";
  protected final String TEXT_290 = NL + "   \t \t\t\t\t    \t\t\t\t}" + NL + "                                 \t\t routines.system.DynamicUtils.readColumnsFromDatabase_Mssql(";
  protected final String TEXT_291 = ", rs_";
  protected final String TEXT_292 = ", fixedColumnCount_";
  protected final String TEXT_293 = ",list_";
  protected final String TEXT_294 = ",";
  protected final String TEXT_295 = NL + "\t\t\t\t\t\t\t\t\t\troutines.system.DynamicUtils.readColumnsFromDatabase_Access(";
  protected final String TEXT_296 = NL + "                                \t\t routines.system.DynamicUtils.readColumnsFromDatabase(";
  protected final String TEXT_297 = NL + "                                  Object geom = rs_";
  protected final String TEXT_298 = ");" + NL + "                                  if (geom != null) {" + NL + "                                  \torg.postgis.Geometry o =" + NL + "                                      org.postgis.PGgeometry.geomFromString(geom.toString());" + NL + "                                \tStringBuffer sb = new StringBuffer();" + NL + "                                \to.outerWKT(sb, false);" + NL + "                                \t";
  protected final String TEXT_299 = " = new Geometry(sb.toString());" + NL + "                                  } else {" + NL + "                                  \t";
  protected final String TEXT_300 = " = null;" + NL + "                                  }";
  protected final String TEXT_301 = NL + "\t\t                          ";
  protected final String TEXT_302 = NL + "\t\t                    }";
  protected final String TEXT_303 = NL + "\t\t\t\t\t";
  protected final String TEXT_304 = " - Retrieving the record \" + nb_line_";
