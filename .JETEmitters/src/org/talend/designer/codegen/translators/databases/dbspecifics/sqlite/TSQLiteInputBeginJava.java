...
public class TSQLiteInputBeginJava
{
  ...
  protected final String TEXT_132 = " = \"jdbc:sqlite:\" + \"/\" + ";
  ...
  protected final String TEXT_144 = NL + "             boolean currentAutoCommitMode";
  protected final String TEXT_145 = " =  conn_";
  protected final String TEXT_146 = ".getAutoCommit();" + NL + "             conn_";
  protected final String TEXT_147 = ".setAutoCommit(true);" + NL + "             try{";
  protected final String TEXT_148 = NL + "                           try{" + NL + "                               conn_";
  protected final String TEXT_149 = ".createStatement().execute(\"BEGIN QUERY LOGGING WITH SQL,OBJECTS ON \" + ";
  protected final String TEXT_150 = ");" + NL + "                           }catch(Exception e){" + NL + "                                 System.err.println(e.getMessage());" + NL + "                           }";
  protected final String TEXT_151 = NL + "                 conn_";
  protected final String TEXT_152 = ".createStatement().execute(" + NL + "              \"SET QUERY_BAND='\" +";
  protected final String TEXT_153 = NL + "               ";
  protected final String TEXT_154 = " + \"=\" + ";
  protected final String TEXT_155 = " + \";\" +";
  protected final String TEXT_156 = " \"' FOR SESSION\"" + NL + "           );" + NL + "              }catch(Exception e){" + NL + "               System.err.println(e.getMessage());" + NL + "      }" + NL + "      conn_";
  protected final String TEXT_157 = ".setAutoCommit(currentAutoCommitMode";
  protected final String TEXT_158 = NL + "\t\t    ";
  protected final String TEXT_159 = NL + NL + "\t\t    String dbquery_";
  protected final String TEXT_160 = ";" + NL + "\t\t\t";
  protected final String TEXT_161 = NL + "                log.debug(\"";
  protected final String TEXT_162 = " - Executing the query: '\"+dbquery_";
