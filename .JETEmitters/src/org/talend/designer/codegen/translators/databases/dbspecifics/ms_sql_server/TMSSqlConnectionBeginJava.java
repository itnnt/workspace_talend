...
public class TMSSqlConnectionBeginJava
{
  ...
  protected final String TEXT_26 = " = \"jdbc:jtds:sqlserver://\" + ";
  protected final String TEXT_27 = " ;";
  protected final String TEXT_28 = "\t\t    " + NL + "\t\t    String url_";
  protected final String TEXT_29 = " = \"jdbc:sqlserver://\" + ";
  protected final String TEXT_30 = NL + "\t\tString port_";
  protected final String TEXT_31 = ";" + NL + "\t\tString dbname_";
  protected final String TEXT_32 = " ;" + NL + "    \tif (!\"\".equals(port_";
  protected final String TEXT_33 = ")) {" + NL + "    \t\turl_";
  protected final String TEXT_34 = " += \":\" + ";
  protected final String TEXT_35 = ";" + NL + "    \t}" + NL + "    \tif (!\"\".equals(dbname_";
  protected final String TEXT_36 = ")) {" + NL + "    \t\t";
  protected final String TEXT_37 = NL + "\t\t\t\turl_";
  protected final String TEXT_38 = " += \"//\" + ";
  protected final String TEXT_39 = "; ";
  protected final String TEXT_40 = "\t\t    " + NL + "\t\t    \turl_";
  protected final String TEXT_41 = " += \";databaseName=\" + ";
  protected final String TEXT_42 = NL + "    \t}" + NL + "\t\turl_";
  protected final String TEXT_43 = " += \";appName=\" + projectName + \";\" + ";
  ...
  protected final String TEXT_82 = " - Uses an existing connection. Connection URL: \" + conn_";
  protected final String TEXT_83 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t";
  ...
  protected final String TEXT_93 = NL + "\t\t\t\tlog.";
  ...
  protected final String TEXT_101 = NL + "\t\t\t\tint countSum_";
  protected final String TEXT_102 = " = 0;" + NL + "\t\t\t\tfor(int countEach_";
  protected final String TEXT_103 = ": pstmt_";
  protected final String TEXT_104 = ".executeBatch()) {" + NL + "\t\t\t\t\tcountSum_";
  protected final String TEXT_105 = " += (countEach_";
  protected final String TEXT_106 = " < 0 ? 0 : ";
  ...
  protected final String TEXT_110 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\tif (dataSources_";
  protected final String TEXT_111 = " == null) {";
  protected final String TEXT_112 = NL + "\t\t";
  protected final String TEXT_113 = NL + NL + "\t\tglobalMap.put(\"conn_";
  protected final String TEXT_114 = "\", conn_";
  protected final String TEXT_115 = NL + "\t} else {" + NL + "\t\tString dsAlias_";
  protected final String TEXT_116 = ";" + NL + "\t\tif (dataSources_";
  protected final String TEXT_117 = ".get(dsAlias_";
  protected final String TEXT_118 = ") == null) {" + NL + "   \t\t\tthrow new Exception(\"No DataSource with alias: \" + dsAlias_";
  protected final String TEXT_119 = " + \" available!\");" + NL + "      \t}" + NL + "\t\tconn_";
  protected final String TEXT_120 = " = dataSources_";
  protected final String TEXT_121 = ").getConnection();" + NL + "\t\tglobalMap.put(\"conn_";
  protected final String TEXT_122 = ");" + NL + "\t}";
  protected final String TEXT_123 = NL + "\tif (null != conn_";
  protected final String TEXT_124 = ") {" + NL + "\t\t";
  protected final String TEXT_125 = NL + "\t}";
  protected final String TEXT_126 = NL + NL + "\tglobalMap.put(\"dbschema_";
  protected final String TEXT_127 = "\", ";
  protected final String TEXT_128 = ");" + NL + "" + NL + "\tglobalMap.put(\"db_";
  protected final String TEXT_129 = "\",  ";
  protected final String TEXT_130 = ");" + NL + "" + NL + "\tglobalMap.put(\"conn_";
  protected final String TEXT_131 = "\",conn_";
  protected final String TEXT_132 = ");" + NL + "\t" + NL + "\tglobalMap.put(\"shareIdentitySetting_";
