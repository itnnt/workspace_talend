...
public class TMysqlOutputBeginJava {
  ...
  protected final String TEXT_136 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_137 = ", \"";
  protected final String TEXT_138 = "\")";
  protected final String TEXT_139 = ".toUpperCase()";
  ...
  protected final String TEXT_146 = NL + "                    String keyCheckTable_";
  protected final String TEXT_147 = " = \"[Informix]\"+\"[\"+";
  protected final String TEXT_148 = "+\"][\"+";
  protected final String TEXT_149 = "+\"]\"+ \"[checktable]\" + \"[\" + ";
  protected final String TEXT_150 = " + \"]\";";
  protected final String TEXT_151 = NL + "                    // [%connection%][checktable][tableName]" + NL + "                    String keyCheckTable_";
  protected final String TEXT_152 = " + \"[checktable]\" + \"[\" + ";
  ...
  protected final String TEXT_157 = NL + "                                boolean whetherExist_";
  protected final String TEXT_158 = " = false;" + NL + "                                try (java.sql.Statement isExistStmt_";
  protected final String TEXT_159 = ".createStatement()) {" + NL + "                                    try {" + NL + "                                        isExistStmt_";
  protected final String TEXT_160 = ".execute(\"SELECT TOP 1 1 FROM [\" + tableName_";
  protected final String TEXT_161 = " + \"]\" );" + NL + "                                        whetherExist_";
  protected final String TEXT_162 = " = true;" + NL + "                                    } catch (java.lang.Exception e){" + NL + "                                        whetherExist_";
  protected final String TEXT_163 = " = false;" + NL + "                                    }" + NL + "                                }";
  ...
  protected final String TEXT_170 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                boolean whetherExist_";
  protected final String TEXT_171 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_177 = " = true;" + NL + "                                    }" + NL + "                                }" + NL;
  protected final String TEXT_178 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_179 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_191 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_192 = "((";
  protected final String TEXT_193 = ")";
  protected final String TEXT_194 = ") || (dbschema_";
  protected final String TEXT_195 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_196 = ".equalsIgnoreCase(schema_";
  protected final String TEXT_197 = ")))) {" + NL + "                                            whetherExist_";
  protected final String TEXT_198 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    String defaultSchema_";
  protected final String TEXT_199 = " = \"public\";" + NL + "                                    if(dbschema_";
  protected final String TEXT_200 = " == null || dbschema_";
  protected final String TEXT_201 = ".trim().length() == 0) {" + NL + "                                        try(java.sql.Statement stmtSchema_";
  ...
  protected final String TEXT_207 = ".getString(\"current_schema\");" + NL + "                                            }" + NL + "                                        }" + NL + "                                    }" + NL + "                                    while(rsTable_";
  protected final String TEXT_208 = ") || ((dbschema_";
  protected final String TEXT_209 = " ==null || dbschema_";
  protected final String TEXT_210 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_211 = "(schema_";
  protected final String TEXT_212 = NL + "                                String tableForSearch_";
  protected final String TEXT_213 = ";" + NL + "                                if(tableForSearch_";
  protected final String TEXT_214 = " != null){" + NL + "                                    if(tableForSearch_";
  protected final String TEXT_215 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_216 = ".endsWith(\"\\\"\")){" + NL + "                                        tableForSearch_";
  protected final String TEXT_217 = " =  tableForSearch_";
  protected final String TEXT_218 = ".substring(1,tableForSearch_";
  protected final String TEXT_219 = ".length()-1);" + NL + "                                    }else{" + NL + "                                        tableForSearch_";
  protected final String TEXT_220 = ".toUpperCase();" + NL + "                                    }" + NL + "                                }" + NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_221 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_222 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_223 = ".getTables(null, conn_";
  protected final String TEXT_224 = ".getSchema(), tableForSearch_";
  protected final String TEXT_225 = ", new String[]{\"TABLE\"})) {" + NL + "                                       if(rsTable_";
  protected final String TEXT_226 = " = true;" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_227 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_228 = ", null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_229 = ".next()) {" + NL + "                                        if(rsTable_";
  protected final String TEXT_230 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  protected final String TEXT_231 = ")) {" + NL + "                                            whetherExist_";
  protected final String TEXT_232 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }" + NL + "                            " + NL + "                            ";
  protected final String TEXT_233 = ".getTables(";
  protected final String TEXT_234 = ", null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_239 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_240 = ".getString(\"TABLE_NAME\");" + NL + "                                        if(table_";
  protected final String TEXT_241 = NL + "                                if(!whetherExist_";
  protected final String TEXT_242 = ") {" + NL + "                                    try (java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_259 = NL + "            try (java.sql.Statement stmtClear_";
  protected final String TEXT_260 = NL + "                              stmtClear_";
  protected final String TEXT_261 = NL + "                stmtClear_";
  protected final String TEXT_262 = ".executeUpdate(\"";
  protected final String TEXT_263 = "\");";
  protected final String TEXT_264 = NL + "            int rsTruncCountNumber_";
  protected final String TEXT_265 = " = 0;" + NL + "            try(java.sql.Statement stmtTruncCount_";
  protected final String TEXT_266 = NL + "                              stmtTruncCount_";
  protected final String TEXT_267 = NL + "                try (java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_268 = " = stmtTruncCount_";
  protected final String TEXT_269 = ".executeQuery(\"";
  protected final String TEXT_270 = "\")) {" + NL + "                    if(rsTruncCount_";
  protected final String TEXT_271 = ".next()) {" + NL + "                        rsTruncCountNumber_";
  protected final String TEXT_272 = " = rsTruncCount_";
  protected final String TEXT_273 = ".getInt(1);" + NL + "                    }" + NL + "                }" + NL + "            }" + NL + "            try (java.sql.Statement stmtTrunc_";
  protected final String TEXT_274 = NL + "                              stmtTrunc_";
  protected final String TEXT_275 = NL + "                conn_";
  protected final String TEXT_276 = NL + "                stmtTrunc_";
  protected final String TEXT_277 = NL + "                    if(!conn_";
  protected final String TEXT_278 = ".getAutoCommit()){" + NL + "                        conn_";
  protected final String TEXT_279 = ".commit();" + NL + "                    }";
  protected final String TEXT_280 = NL + "                deletedCount_";
  protected final String TEXT_281 = " += rsTruncCountNumber_";
  protected final String TEXT_282 = ";" + NL + "            }";
  protected final String TEXT_283 = NL + "            try (java.sql.Statement stmtTruncCount_";
  ...
  protected final String TEXT_286 = NL + "                while(rsTruncCount_";
  protected final String TEXT_287 = ".next()) {" + NL + "                    deletedCount_";
  protected final String TEXT_288 = " += rsTruncCount_";
  protected final String TEXT_289 = ".getInt(1);" + NL + "                }" + NL + "            }";
  protected final String TEXT_290 = NL + "\t\t\tStringBuffer duplidateClause_";
  protected final String TEXT_291 = " = new StringBuffer(\" ON DUPLICATE KEY UPDATE \");" + NL + "\t\t\t\t";
  protected final String TEXT_292 = NL + "\t\t\t\t\t\tduplidateClause_";
  ...
  protected final String TEXT_299 = NL + "\t\t        String insert_";
  protected final String TEXT_300 = " = \"INSERT INTO `\" + ";
  protected final String TEXT_301 = " + \"` (";
  protected final String TEXT_302 = ") VALUES (";
  protected final String TEXT_303 = ")\";";
  protected final String TEXT_304 = NL + "\t\t\t\tinsert_";
  protected final String TEXT_305 = " += \tduplidateClause_";
  protected final String TEXT_306 = ".toString();";
  protected final String TEXT_307 = NL + "\t\t\t\t";
  protected final String TEXT_308 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_309 = " = new StringBuffer(insert_";
  protected final String TEXT_310 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_311 = ".insert(insert_";
  protected final String TEXT_312 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_313 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_314 = " =insertStringBuffer_";
  protected final String TEXT_315 = ".toString(); ";
  protected final String TEXT_316 = "    " + NL;
  protected final String TEXT_317 = NL + "                        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_318 = ".prepareStatement(insert_";
  ...
  protected final String TEXT_322 = " = null;" + NL + "                        // [%connection%][psmt][tableName]" + NL + "                        String keyPsmt_";
  protected final String TEXT_323 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_324 = " + \"]\";" + NL + "                        pstmt_";
  protected final String TEXT_325 = " = SharedDBPreparedStatement.getSharedPreparedStatement(conn_";
  protected final String TEXT_326 = ",insert_";
  protected final String TEXT_327 = ",keyPsmt_";
  protected final String TEXT_328 = NL + "\t            class BufferLine_";
  protected final String TEXT_329 = " {" + NL + "    \t            ";
  protected final String TEXT_330 = " ";
  protected final String TEXT_331 = ";";
  protected final String TEXT_332 = NL + NL + "\t                public BufferLine_";
  protected final String TEXT_333 = NL + "                                ,";
  protected final String TEXT_334 = NL + "\t                ){" + NL + "\t                    ";
  protected final String TEXT_335 = NL + "                                this.";
  protected final String TEXT_336 = NL + "                    }" + NL + "\t            }" + NL + "" + NL + "\t            java.util.List<BufferLine_";
  protected final String TEXT_337 = "> exInsertColValueList";
  protected final String TEXT_338 = " = new java.util.ArrayList();" + NL + "\t            BufferLine_";
  protected final String TEXT_339 = " exInsertColValue";
  protected final String TEXT_340 = " = null;" + NL + "" + NL + "" + NL + "\t            StringBuilder extendInsertValueStmt_";
  protected final String TEXT_341 = " = new StringBuilder();" + NL + "                for(int i=0;i < ";
  protected final String TEXT_342 = ";i++){" + NL + "                     extendInsertValueStmt_";
  protected final String TEXT_343 = ".append(\"(";
  protected final String TEXT_344 = ")\");" + NL + "                     if (i!=";
  protected final String TEXT_345 = "-1) extendInsertValueStmt_";
  protected final String TEXT_346 = ".append(\",\");" + NL + "                }" + NL + "" + NL + "" + NL + "\t\t\t\tString insert_";
  protected final String TEXT_347 = " = \"INSERT INTO `\"+";
  protected final String TEXT_348 = "+\"` (";
  protected final String TEXT_349 = ") VALUES \" + extendInsertValueStmt_";
  ...
  protected final String TEXT_353 = ");" + NL + "" + NL + "\t            String insertColName";
  protected final String TEXT_354 = "\";" + NL + "\t            String insertColValue";
  protected final String TEXT_355 = " =  \"";
  protected final String TEXT_356 = "\";" + NL + "\t            int rowCount";
  protected final String TEXT_357 = NL + "\t\t\t\tString insert_";
  protected final String TEXT_358 = NL + "\t\t        int batchSize_";
  protected final String TEXT_359 = ";" + NL + "\t   \t\t\tint batchSizeCounter_";
  protected final String TEXT_360 = "=0;" + NL + "\t\t        ";
  protected final String TEXT_361 = "    " + NL + "\t\t        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_362 = ");" + NL + "\t\t        resourceMap.put(\"pstmt_";
  protected final String TEXT_363 = ");" + NL;
  protected final String TEXT_364 = NL + "\t    String update_";
  protected final String TEXT_365 = " = \"UPDATE `\" + ";
  protected final String TEXT_366 = " + \"` SET ";
  protected final String TEXT_367 = " WHERE ";
  protected final String TEXT_368 = "\";" + NL + "\t    ";
  protected final String TEXT_369 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_370 = " = new StringBuffer(update_";
  protected final String TEXT_371 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_372 = ".insert(update_";
  protected final String TEXT_373 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_374 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_375 = " =updateStringBuffer_";
  ...
  protected final String TEXT_380 = ".prepareStatement(\"SELECT COUNT(1) FROM `\" + ";
  protected final String TEXT_381 = " + \"` WHERE ";
  protected final String TEXT_382 = "\");" + NL + "\t    resourceMap.put(\"pstmt_";
  protected final String TEXT_383 = ");" + NL + "\t    String insert_";
  protected final String TEXT_384 = ")\";" + NL + "\t    ";
  protected final String TEXT_385 = "    " + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_386 = ");" + NL + "\t    resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_387 = "\", pstmtInsert_";
  protected final String TEXT_388 = ");" + NL + "\t    String update_";
  protected final String TEXT_389 = NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_390 = ");" + NL + "\t    resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_391 = "\", pstmtUpdate_";
  protected final String TEXT_392 = ")\";" + NL + "\t     ";
  protected final String TEXT_393 = NL + "\t    String delete_";
  protected final String TEXT_394 = " = \"DELETE FROM `\" + ";
  protected final String TEXT_395 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_396 = " = new StringBuffer(delete_";
  protected final String TEXT_397 = ");" + NL + "    deleteStringBuffer_";
  protected final String TEXT_398 = ".insert(delete_";
  protected final String TEXT_399 = ".indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_400 = "  + \" \" );" + NL + "    delete_";
  protected final String TEXT_401 = " =deleteStringBuffer_";
  protected final String TEXT_402 = ".toString();  ";
  protected final String TEXT_403 = NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_404 = ".prepareStatement(delete_";
  protected final String TEXT_405 = NL + "\t    String replace_";
  protected final String TEXT_406 = " = \"REPLACE INTO `\" + ";
  protected final String TEXT_407 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_408 = ".prepareStatement(replace_";
  protected final String TEXT_409 = NL + "\t    String insertIgnore_";
  protected final String TEXT_410 = " = \"INSERT IGNORE INTO `\" + ";
  protected final String TEXT_411 = ") ON DUPLICATE KEY UPDATE ";
  protected final String TEXT_412 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_413 = ".prepareStatement(insertIgnore_";
  protected final String TEXT_414 = NL + "\t    String insert_";
  protected final String TEXT_415 = "    " + NL + "\t    java.sql.PreparedStatement pstmt_";
  protected final String TEXT_416 = NL + "        StringBuffer query_";
  ...
  protected final String TEXT_435 = NL + NL + "\tclass BufferLine_";
  protected final String TEXT_436 = NL + "\t\t\t\troutines.system.Dynamic ";
  protected final String TEXT_437 = ";" + NL + "\t\t\t";
  protected final String TEXT_438 = NL + "\t\t\t\t, routines.system.Dynamic ";
  protected final String TEXT_439 = NL + "\t\t\t";
  protected final String TEXT_440 = NL + "\t\t\t\tthis.";
  protected final String TEXT_441 = "=";
  protected final String TEXT_442 = NL + "                    }" + NL + "\t            }" + NL + "" + NL + "\t\t    java.util.List<BufferLine_";
  protected final String TEXT_443 = " = null;" + NL + "\t\t    String insert_";
  protected final String TEXT_444 = "=\"\";" + NL + "\t\t    String insertColValue";
  protected final String TEXT_445 = "=\"\";" + NL + "\t\t    String insertColName";
  protected final String TEXT_446 = "=\"\";" + NL + "\t\t    int counter";
  protected final String TEXT_447 = "=1;";
  protected final String TEXT_448 = NL + "\tint batchSizeCounter_";
  protected final String TEXT_449 = "=0;" + NL + "\tint batchSize_";
  protected final String TEXT_450 = NL + "\tjava.sql.PreparedStatement pstmt_";
  protected final String TEXT_451 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_452 = " =null;" + NL + "\tjava.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_453 = " =null;" + NL + "\tint rowCount";
  protected final String TEXT_454 = "=0;" + NL + "\t";
  protected final String TEXT_455 = NL + "\t\tStringBuffer query_";
  protected final String TEXT_456 = " = null;" + NL + "\t\t";
  protected final String TEXT_457 = NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_458 = " =  null;";
  protected final String TEXT_459 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_460 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_461 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_462 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_463 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
