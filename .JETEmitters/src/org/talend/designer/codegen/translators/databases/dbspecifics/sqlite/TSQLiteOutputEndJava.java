...
public class TSQLiteOutputEndJava {
  ...
  protected final String TEXT_79 = NL + "        if (commitCounter_";
  protected final String TEXT_80 = " > 0) {";
  protected final String TEXT_81 = NL + "            conn_";
  protected final String TEXT_82 = ".commit();";
  protected final String TEXT_83 = NL + "        }";
  protected final String TEXT_84 = NL + "        conn_";
  protected final String TEXT_85 = " .close();";
  protected final String TEXT_86 = NL + "\t\tresourceMap.put(\"finish_";
  protected final String TEXT_87 = NL + NL + "\tint rejectedCount_";
  protected final String TEXT_88 = " = 0;";
  protected final String TEXT_89 = NL + "\tnb_line_deleted_";
  ...
  protected final String TEXT_102 = NL + "    \tif (globalMap.get(\"";
  protected final String TEXT_103 = "_NB_LINE\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_104 = "_NB_LINE\",nb_line_";
  protected final String TEXT_105 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_106 = "_NB_LINE\",(Integer)globalMap.get(\"";
  protected final String TEXT_107 = "_NB_LINE\") + nb_line_";
  protected final String TEXT_108 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_109 = "_NB_LINE_UPDATED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_110 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_111 = "_NB_LINE_UPDATED\",(Integer)globalMap.get(\"";
  protected final String TEXT_112 = "_NB_LINE_UPDATED\") + nb_line_update_";
  protected final String TEXT_113 = "_NB_LINE_INSERTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_114 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_115 = "_NB_LINE_INSERTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_116 = "_NB_LINE_INSERTED\") + nb_line_inserted_";
  protected final String TEXT_117 = "_NB_LINE_DELETED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_118 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_119 = "_NB_LINE_DELETED\",(Integer)globalMap.get(\"";
  protected final String TEXT_120 = "_NB_LINE_DELETED\") + nb_line_deleted_";
  protected final String TEXT_121 = "_NB_LINE_REJECTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_122 = "_NB_LINE_REJECTED\",nb_line_rejected_";
