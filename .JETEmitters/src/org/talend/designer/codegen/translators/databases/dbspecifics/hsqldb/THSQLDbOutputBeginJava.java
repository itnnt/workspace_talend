...
public class THSQLDbOutputBeginJava {
  ...
  protected final String TEXT_38 = " = \"jdbc:hsqldb:hsqls://\" + ";
  protected final String TEXT_39 = " + \":\" + ";
  protected final String TEXT_40 = " + \"/\" + ";
  protected final String TEXT_41 = ";" + NL + "\t\t\t";
  protected final String TEXT_42 = " = \"jdbc:hsqldb:hsql://\" + ";
  protected final String TEXT_43 = " = \"jdbc:hsqldb:https://\" + ";
  protected final String TEXT_44 = " = \"jdbc:hsqldb:http://\" + ";
  protected final String TEXT_45 = NL + "\t\turl_";
  protected final String TEXT_46 = " = \"jdbc:hsqldb:file:\" + ";
  protected final String TEXT_47 = " ;" + NL + "\t\t";
  protected final String TEXT_48 = " = \"jdbc:hsqldb:mem:\" + ";
  ...
  protected final String TEXT_60 = "=0;" + NL + "" + NL + "String tableName_";
  ...
  protected final String TEXT_70 = " " + NL + "java.lang.Class.forName(\"org.hsqldb.jdbcDriver\");";
  ...
  protected final String TEXT_76 = NL + NL + "String dbPwd_";
  ...
  protected final String TEXT_82 = NL + "resourceMap.put(\"conn_";
  protected final String TEXT_83 = "\", conn_";
  protected final String TEXT_84 = ");" + NL + "conn_";
  protected final String TEXT_85 = ".setAutoCommit(false);";
  protected final String TEXT_86 = NL + "            try (java.sql.Statement stmtDrop_";
  protected final String TEXT_87 = " = conn_";
  protected final String TEXT_88 = ".createStatement();" + NL + "                    java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_98 = ".getMetaData();" + NL + "            boolean whetherExist_";
  protected final String TEXT_99 = " = false;" + NL + "            try (java.sql.ResultSet rsTable_";
  protected final String TEXT_100 = " = dbMetaData_";
  protected final String TEXT_101 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                while(rsTable_";
  ...
  protected final String TEXT_107 = " = true;" + NL + "                        break;" + NL + "                    }" + NL + "                }" + NL + "            }";
  ...
  protected final String TEXT_112 = NL + "                if(whetherExist_";
  protected final String TEXT_113 = ") {" + NL + "                    try (java.sql.Statement stmtDrop_";
  protected final String TEXT_114 = NL + "                        stmtDrop_";
  protected final String TEXT_115 = NL + "                    }" + NL + "                }" + NL + "                try (java.sql.Statement stmtCreate_";
  protected final String TEXT_116 = NL + "                    stmtCreate_";
  protected final String TEXT_117 = NL + "                }";
  protected final String TEXT_118 = NL + "            try (java.sql.Statement stmtClear_";
  protected final String TEXT_119 = NL + "                deletedCount_";
  protected final String TEXT_120 = " = deletedCount_";
  protected final String TEXT_121 = " + stmtClear_";
  protected final String TEXT_122 = ".executeUpdate(\"";
  ...
  protected final String TEXT_128 = ".prepareStatement(insert_";
  protected final String TEXT_129 = ");" + NL + "\t    resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_139 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + ";
  protected final String TEXT_140 = " + \" WHERE ";
  protected final String TEXT_141 = "\");" + NL + "\t    resourceMap.put(\"pstmt_";
  protected final String TEXT_142 = ");" + NL + "\t    String insert_";
  protected final String TEXT_143 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_144 = ");" + NL + "\t    resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_145 = "\", pstmtInsert_";
  ...
  protected final String TEXT_148 = ");" + NL + "\t    resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_149 = "\", pstmtUpdate_";
  protected final String TEXT_150 = NL + "\t    String delete_";
  protected final String TEXT_151 = " = \"DELETE  FROM \" + ";
  protected final String TEXT_152 = ".prepareStatement(delete_";
  ...
  protected final String TEXT_161 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_162 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  ...
  protected final String TEXT_172 = NL + "        " + NL + "        int commitEvery_";
  protected final String TEXT_173 = ";" + NL + "        " + NL + "        int commitCounter_";
