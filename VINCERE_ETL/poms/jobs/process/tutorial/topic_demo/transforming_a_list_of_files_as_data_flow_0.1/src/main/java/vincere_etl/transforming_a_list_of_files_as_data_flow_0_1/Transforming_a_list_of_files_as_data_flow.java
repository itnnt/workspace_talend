...
package vincere_etl.transforming_a_list_of_files_as_data_flow_0_1;
...
/**
 * Job: Transforming_a_list_of_files_as_data_flow Purpose: <br>
 * Description: Transforming a list of files as data flow <br>
 * 
 * @author user@talend.com
 * @version 7.2.1.20190620_1446
 * @status
 */
public class Transforming_a_list_of_files_as_data_flow implements TalendJob {
	...
	private final String jobName = "Transforming_a_list_of_files_as_data_flow";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Transforming_a_list_of_files_as_data_flow.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Transforming_a_list_of_files_as_data_flow.this,
	...
	public static class OnSubjobOkStructtIterateToFlow_1
		...
		final static byte[] commonByteArrayLock_VINCERE_ETL_Transforming_a_list_of_files_as_data_flow = new byte[0];
		static byte[] commonByteArray_VINCERE_ETL_Transforming_a_list_of_files_as_data_flow = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_VINCERE_ETL_Transforming_a_list_of_files_as_data_flow.length) {
					if (length < 1024
							&& commonByteArray_VINCERE_ETL_Transforming_a_list_of_files_as_data_flow.length == 0) {
						commonByteArray_VINCERE_ETL_Transforming_a_list_of_files_as_data_flow = new byte[1024];
					} else {
						commonByteArray_VINCERE_ETL_Transforming_a_list_of_files_as_data_flow = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_VINCERE_ETL_Transforming_a_list_of_files_as_data_flow, 0, length);
				strReturn = new String(commonByteArray_VINCERE_ETL_Transforming_a_list_of_files_as_data_flow, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_VINCERE_ETL_Transforming_a_list_of_files_as_data_flow) {
	...
	public void tFileList_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String directory_tFileList_1 = "/Users/tungnguyen/Downloads/9781782167266_code";
				...
				for (int i_tFileList_1 = 0; i_tFileList_1 < list_tFileList_1.size(); i_tFileList_1++) {
					...
					struct_tIterateToFlow_1_ITFO.Date = TalendDate.getCurrentDate();
	...
	public void tIterateToFlow_1_AIProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				util_tLogRow_1.addRow(new String[] { "Filename", "Date", });
...
///////////////////////    			
				...
				for (OnSubjobOkStructtIterateToFlow_1 row_tIterateToFlow_1_AI : list_tIterateToFlow_1_AI) {
					...
					row1.Date = row_tIterateToFlow_1_AI.Date;
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final Transforming_a_list_of_files_as_data_flow Transforming_a_list_of_files_as_data_flowClass = new Transforming_a_list_of_files_as_data_flow();

		int exitCode = Transforming_a_list_of_files_as_data_flowClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Transforming_a_list_of_files_as_data_flow.class.getClassLoader()
					.getResourceAsStream("vincere_etl/transforming_a_list_of_files_as_data_flow_0_1/contexts/"
							+ contextStr + ".properties");
			if (inContext == null) {
				inContext = Transforming_a_list_of_files_as_data_flow.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : Transforming_a_list_of_files_as_data_flow");
		}
...
/************************************************************************************************
 * 51537 characters generated by Talend Open Studio for Data Integration on the
 * August 30, 2019 at 1:59:01 PM ICT
 ************************************************************************************************/