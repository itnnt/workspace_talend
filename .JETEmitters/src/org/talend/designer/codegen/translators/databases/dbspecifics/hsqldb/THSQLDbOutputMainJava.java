...
public class THSQLDbOutputMainJava {
  ...
  protected final String TEXT_38 = NL + "\t\tquery_";
  protected final String TEXT_39 = " = new StringBuffer(\"\");";
  protected final String TEXT_40 = NL + "\t\t\t\tcommitEvery_";
  protected final String TEXT_41 = " = buffersSize_";
  ...
  protected final String TEXT_50 = NL + "            try {" + NL + "                insertedCount_";
  ...
  protected final String TEXT_55 = NL + "            } catch(java.lang.Exception e) {" + NL + "                whetherReject_";
  protected final String TEXT_56 = " = true;";
  protected final String TEXT_57 = NL + "                    throw(e);";
  protected final String TEXT_58 = " = new ";
  protected final String TEXT_59 = "Struct();";
  protected final String TEXT_60 = NL + "                        rejectedCount_";
  protected final String TEXT_61 = " = rejectedCount_";
  protected final String TEXT_62 = " + 1;";
  protected final String TEXT_63 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_64 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_65 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_66 = NL + "            }";
  protected final String TEXT_67 = NL + "            try {" + NL + "                updatedCount_";
  protected final String TEXT_68 = " = updatedCount_";
  protected final String TEXT_69 = NL + "            int checkCount_";
  protected final String TEXT_70 = " = -1;" + NL + "            try (java.sql.ResultSet rs_";
  protected final String TEXT_71 = " = pstmt_";
  protected final String TEXT_72 = ".executeQuery()) {" + NL + "                while(rs_";
  protected final String TEXT_73 = ".next()) {" + NL + "                    checkCount_";
  protected final String TEXT_74 = " = rs_";
  protected final String TEXT_75 = ".getInt(1);" + NL + "                }" + NL + "            }" + NL + "            if(checkCount_";
  protected final String TEXT_76 = " > 0) {";
  protected final String TEXT_77 = NL + "                            query_";
  protected final String TEXT_78 = NL + "                    globalMap.put(\"";
  protected final String TEXT_79 = NL + "                try {" + NL + "                    updatedCount_";
  protected final String TEXT_80 = " + pstmtUpdate_";
  protected final String TEXT_81 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_82 = "++;" + NL + "        \t\t\t";
  protected final String TEXT_83 = NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  ...
  protected final String TEXT_91 = NL + "                try {" + NL + "                    insertedCount_";
  protected final String TEXT_92 = " + pstmtInsert_";
  protected final String TEXT_93 = NL + "                }" + NL + "            }";
  protected final String TEXT_94 = NL + "            int updateFlag_";
  protected final String TEXT_95 = "=0;";
  protected final String TEXT_96 = "  " + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_97 = "=pstmtUpdate_";
  protected final String TEXT_98 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_99 = " + updateFlag_";
  protected final String TEXT_100 = ";" + NL + "            if(updateFlag_";
  protected final String TEXT_101 = " == 0) {" + NL + "            \t";
  protected final String TEXT_102 = NL + "\t\t\t\tquery_";
  protected final String TEXT_103 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_104 = NL + "                    insertedCount_";
  protected final String TEXT_105 = ".executeUpdate();  " + NL + "         \t\t\tnb_line_";
  protected final String TEXT_106 = NL + "    \t\t\t}else{" + NL + "    \t\t\t\tnb_line_";
  protected final String TEXT_107 = "++;" + NL + "    \t\t\t\t";
  protected final String TEXT_108 = NL + "    \t\t\t}" + NL + "                } catch(java.lang.Exception e) {" + NL + "                    whetherReject_";
  protected final String TEXT_109 = NL + "                }";
  protected final String TEXT_110 = NL + "            try {" + NL + "                deletedCount_";
  protected final String TEXT_111 = " = deletedCount_";
  protected final String TEXT_112 = NL + "                \tnb_line_";
  protected final String TEXT_113 = "++;" + NL + "                \t";
  protected final String TEXT_114 = NL + "            if(!whetherReject_";
  protected final String TEXT_115 = ") {";
  protected final String TEXT_116 = NL + "            commitCounter_";
  protected final String TEXT_117 = "++;" + NL + "            " + NL + "            if(commitEvery_";
  protected final String TEXT_118 = " <= commitCounter_";
  ...
  protected final String TEXT_123 = "=0;" + NL + "            " + NL + "            }" + NL + "        ";
