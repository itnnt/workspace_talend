...
package vincere_etl.mock_job_for_guess_schema_0_1;
	...
	public void tJavaFlex_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String url = "jdbc:mysql://:3306/batchinsertdemo1?autoReconnect=true&useSSL=false";
				java.sql.Connection conn = java.sql.DriverManager.getConnection(url, "root", "justapassword");
...
// Exception is thrown if db don't support, no need to catch exception here
				...
				java.sql.ResultSet rs = stm.executeQuery("select * from emails");
				java.sql.ResultSetMetaData rsmd = rs.getMetaData();
				int numbOfColumn = rsmd.getColumnCount();

				String fileName = (new java.io.File(
						"/Applications/TOSDI-7.2.1/studio/TOS_DI-macosx-cocoa.app/Contents/MacOS/temp/TempGuessSchemaDelimitedFile.csv"))
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Mock_job_for_Guess_schema.class.getClassLoader().getResourceAsStream(
					"vincere_etl/mock_job_for_guess_schema_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 32181 characters generated by Talend Open Studio for Data Integration on the
 * November 23, 2019 at 3:54:46 PM ICT
 ************************************************************************************************/