...
public class TFTPGetEndJava
{
  ...
  protected final String TEXT_22 = ".add(ftp_";
  protected final String TEXT_23 = ".getDownloadCount() + \" files have been downloaded.\");" + NL + "\tString[] msgAll_";
  protected final String TEXT_24 = " = msg_";
  protected final String TEXT_25 = ".getAll();" + NL + "\tStringBuffer sb_";
  protected final String TEXT_26 = " = new StringBuffer();" + NL + "" + NL + "\tif (msgAll_";
  protected final String TEXT_27 = " != null) {" + NL + "    \tfor (String item_";
  protected final String TEXT_28 = " : msgAll_";
  ...
  protected final String TEXT_38 = NL + "    \t\t} catch(java.net.SocketException se_";
  protected final String TEXT_39 = ") {" + NL + "\t\t\t\t";
  protected final String TEXT_40 = NL + "\t\t\t\t\tlog.error(\"";
  protected final String TEXT_41 = " - \" + se_";
  protected final String TEXT_42 = ".getMessage());" + NL + "\t\t\t\t";
  protected final String TEXT_43 = NL + "        \t\t//ignore failure" + NL + "      \t\t}";
  protected final String TEXT_44 = NL + "\t\t\t";
  protected final String TEXT_45 = NL + "\t\t\t\tlog.info(\"";
  protected final String TEXT_46 = " - Closing the connection to the server.\");" + NL + "\t\t\t";
  protected final String TEXT_47 = NL + "      \t\tftp_";
  protected final String TEXT_48 = ".quit();" + NL + "\t\t\t";
  protected final String TEXT_49 = " - Connection to the server closed.\");" + NL + "\t\t\t";
  protected final String TEXT_50 = NL + "\t  \t\tftp_";
  protected final String TEXT_51 = ".chdir(rootDir_";
  protected final String TEXT_52 = ");";
  protected final String TEXT_53 = NL + "    \tftp_";
  protected final String TEXT_54 = ".disconnect();" + NL + "\t\t";
  protected final String TEXT_55 = NL + "\t\t\tftp_";
  protected final String TEXT_56 = ".changeWorkingDirectory(rootDir_";
  protected final String TEXT_57 = NL + "\tglobalMap.put(\"";
  protected final String TEXT_58 = "_NB_FILE\",nb_file_";
  protected final String TEXT_59 = NL + "\tlog.info(\"";
  protected final String TEXT_60 = " - Downloaded files count: \" + nb_file_";
