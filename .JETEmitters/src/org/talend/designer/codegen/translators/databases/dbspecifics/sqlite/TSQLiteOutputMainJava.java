...
public class TSQLiteOutputMainJava {
  ...
  protected final String TEXT_39 = NL + "\t\t\t\tcommitEvery_";
  protected final String TEXT_40 = " = buffersSize_";
  protected final String TEXT_41 = ";";
  protected final String TEXT_42 = NL + "            batchSize_";
  ...
  protected final String TEXT_51 = ".addBatch();" + NL + "                       batchSizeCounter_";
  protected final String TEXT_52 = "++;" + NL + "                       nb_line_";
  protected final String TEXT_53 = "++;";
  protected final String TEXT_54 = NL + "                       try {" + NL + "                           insertedCount_";
  protected final String TEXT_55 = " = insertedCount_";
  protected final String TEXT_56 = " + pstmt_";
  protected final String TEXT_57 = ".executeUpdate();" + NL + "                           nb_line_";
  protected final String TEXT_58 = NL + "                       } catch(java.lang.Exception e) {" + NL + "                           whetherReject_";
  ...
  protected final String TEXT_66 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_67 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_68 = NL + "                                   System.err.print(e.getMessage());";
  protected final String TEXT_69 = NL + "                       }";
  protected final String TEXT_70 = NL + NL + "\t\t\t\t\t";
  protected final String TEXT_71 = NL + "                    \t";
  protected final String TEXT_72 = NL + "                        try {" + NL + "                            updatedCount_";
  ...
  protected final String TEXT_83 = NL + "            int checkCount_";
  protected final String TEXT_84 = " = -1;" + NL + "            try (java.sql.ResultSet rs_";
  protected final String TEXT_85 = " = pstmt_";
  protected final String TEXT_86 = ".executeQuery()) {" + NL + "                while(rs_";
  protected final String TEXT_87 = ".next()) {" + NL + "                    checkCount_";
  protected final String TEXT_88 = " = rs_";
  protected final String TEXT_89 = ".getInt(1);" + NL + "                }" + NL + "            }" + NL + "            if(checkCount_";
  ...
  protected final String TEXT_102 = NL + "                         nb_line_";
  ...
  protected final String TEXT_111 = NL + "            int updateFlag_";
  protected final String TEXT_112 = "=0;";
  protected final String TEXT_113 = NL + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_114 = "=pstmtUpdate_";
  protected final String TEXT_115 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_116 = " + updateFlag_";
  ...
  protected final String TEXT_121 = NL + "            }" + NL + "            if(updateFlag_";
  ...
  protected final String TEXT_125 = NL + "                }" + NL + "            }else{" + NL + "            \tnb_line_";
  protected final String TEXT_126 = "++;" + NL + "\t\t\t\t";
  protected final String TEXT_127 = NL + "            }";
  protected final String TEXT_128 = NL + "                     pstmt_";
  protected final String TEXT_129 = ".addBatch();" + NL + "                     batchSizeCounter_";
  protected final String TEXT_130 = "++;" + NL + "                     nb_line_";
  protected final String TEXT_131 = NL + "                      try {" + NL + "                          deletedCount_";
  protected final String TEXT_132 = " = deletedCount_";
  protected final String TEXT_133 = ".executeUpdate();" + NL + "                          nb_line_";
  protected final String TEXT_134 = NL + "                      } catch(java.lang.Exception e) {" + NL + "                          whetherReject_";
  protected final String TEXT_135 = NL + "                              throw(e);";
  protected final String TEXT_136 = NL + "                               nb_line_";
  ...
  protected final String TEXT_142 = NL + "            if(!whetherReject_";
  protected final String TEXT_143 = ") {";
  protected final String TEXT_144 = NL + "                if ((batchSize_";
  protected final String TEXT_145 = " > 0) && (batchSize_";
  protected final String TEXT_146 = " <= batchSizeCounter_";
  protected final String TEXT_147 = ")) {" + NL + "                    int[] status_";
  protected final String TEXT_148 = " = null;" + NL + "                    int countSum_";
  protected final String TEXT_149 = " = 0;" + NL + "                    try {" + NL + "                        batchSizeCounter_";
  protected final String TEXT_150 = " = 0;";
  protected final String TEXT_151 = NL + "                        status_";
  protected final String TEXT_152 = ".executeBatch();";
  protected final String TEXT_153 = NL + "                        for(int countEach_";
  protected final String TEXT_154 = ": status_";
  protected final String TEXT_155 = ") {" + NL + "                            countSum_";
  protected final String TEXT_156 = " += (countEach_";
  protected final String TEXT_157 = " < 0 ? 0 : countEach_";
  protected final String TEXT_158 = ");" + NL + "                        }" + NL + "                    }catch (java.sql.BatchUpdateException e){";
  protected final String TEXT_159 = NL + "                            throw(e);";
  protected final String TEXT_160 = ": e.getUpdateCounts()) {" + NL + "                            countSum_";
  protected final String TEXT_161 = ");" + NL + "                        }";
  protected final String TEXT_162 = NL + "                        System.err.println(e.getMessage());";
  protected final String TEXT_163 = NL + "                    }" + NL + "                    try {" + NL + "                        tmp_batchUpdateCount_";
  protected final String TEXT_164 = ".getUpdateCount();" + NL + "                    }catch (java.sql.SQLException e){";
  protected final String TEXT_165 = NL + "                        System.err.println(e.getMessage());" + NL + "                    }" + NL + "                    tmp_batchUpdateCount_";
  protected final String TEXT_166 = " = tmp_batchUpdateCount_";
  protected final String TEXT_167 = " > countSum_";
  protected final String TEXT_168 = " ? tmp_batchUpdateCount_";
  protected final String TEXT_169 = " : countSum_";
  protected final String TEXT_170 = NL + "                        insertedCount_";
  protected final String TEXT_171 = " += tmp_batchUpdateCount_";
  protected final String TEXT_172 = NL + "                        updatedCount_";
  protected final String TEXT_173 = NL + "                        deletedCount_";
  protected final String TEXT_174 = NL + "               }";
  protected final String TEXT_175 = NL + "                commitCounter_";
  protected final String TEXT_176 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_177 = " <= commitCounter_";
  protected final String TEXT_178 = NL + "                try {" + NL + "                    if (batchSizeCounter_";
  protected final String TEXT_179 = " > 0) {" + NL + "\t                    int countSum_";
  protected final String TEXT_180 = " = 0;" + NL + "\t                    ";
  protected final String TEXT_181 = NL + "\t                    for(int countEach_";
  protected final String TEXT_182 = ": pstmt_";
  protected final String TEXT_183 = ".executeBatch()) {" + NL + "\t                        countSum_";
  protected final String TEXT_184 = ");" + NL + "\t                    }" + NL + "\t                    ";
  protected final String TEXT_185 = NL + "\t                        insertedCount_";
  protected final String TEXT_186 = " += countSum_";
  protected final String TEXT_187 = ";" + NL + "\t                    ";
  protected final String TEXT_188 = NL + "\t                        updatedCount_";
  protected final String TEXT_189 = NL + "\t                        deletedCount_";
  protected final String TEXT_190 = NL + "\t                    batchSizeCounter_";
  protected final String TEXT_191 = " = 0;" + NL + "                    }" + NL + "                }catch (java.sql.BatchUpdateException e){";
  ...
  protected final String TEXT_195 = NL + "                            updatedCount_";
  protected final String TEXT_196 = NL + "                            deletedCount_";
  protected final String TEXT_197 = NL + "                }";
  protected final String TEXT_198 = NL + "                conn_";
  protected final String TEXT_199 = ".commit();";
