...
public class TPostgresqlOutputMainJava {
  ...
  protected final String TEXT_59 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(";
  protected final String TEXT_60 = ", \"";
  protected final String TEXT_61 = "\")";
  protected final String TEXT_62 = ".toUpperCase()";
  ...
  protected final String TEXT_69 = NL + "                    String keyCheckTable_";
  protected final String TEXT_70 = " = \"[Informix]\"+\"[\"+";
  ...
  protected final String TEXT_75 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_76 = NL + NL + "                if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_77 = ")== null){//}" + NL + "" + NL + "                    synchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_78 = ")) {//}" + NL + "                        if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_79 = ")== null){//}";
  protected final String TEXT_80 = NL + "                                boolean whetherExist_";
  protected final String TEXT_81 = " = false;" + NL + "                                try (java.sql.Statement isExistStmt_";
  protected final String TEXT_82 = ".createStatement()) {" + NL + "                                    try {" + NL + "                                        isExistStmt_";
  protected final String TEXT_83 = ".execute(\"SELECT TOP 1 1 FROM [\" + tableName_";
  protected final String TEXT_84 = " + \"]\" );" + NL + "                                        whetherExist_";
  protected final String TEXT_85 = " = true;" + NL + "                                    } catch (java.lang.Exception e){" + NL + "                                        whetherExist_";
  protected final String TEXT_86 = " = false;" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_87 = NL + "                                ";
  protected final String TEXT_88 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_89 = ".getMetaData();" + NL + "                                if(tableNameForSearch_";
  protected final String TEXT_90 = ".indexOf(\"\\\"\")==-1){" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_91 = " = tableNameForSearch_";
  protected final String TEXT_92 = ".toUpperCase();" + NL + "                                }else{" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_93 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                boolean whetherExist_";
  protected final String TEXT_94 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  protected final String TEXT_95 = " = dbMetaData_";
  protected final String TEXT_96 = ".getTables(null, dbschemaForSearch_";
  protected final String TEXT_97 = ", tableNameForSearch_";
  protected final String TEXT_98 = ", new String[]{\"TABLE\"})) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_99 = ".next()) {" + NL + "                                        whetherExist_";
  protected final String TEXT_100 = " = true;" + NL + "                                    }" + NL + "                                }" + NL;
  protected final String TEXT_101 = ".getMetaData();" + NL + "                                boolean whetherExist_";
  protected final String TEXT_102 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  ...
  protected final String TEXT_110 = ")" + NL + "                                            && (schema_";
  ...
  protected final String TEXT_114 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_115 = "((";
  protected final String TEXT_116 = ")";
  protected final String TEXT_117 = ") || (dbschema_";
  protected final String TEXT_118 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_119 = ".equalsIgnoreCase(schema_";
  protected final String TEXT_120 = ")))) {" + NL + "                                            whetherExist_";
  protected final String TEXT_121 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    String defaultSchema_";
  protected final String TEXT_122 = " = \"public\";" + NL + "                                    if(dbschema_";
  protected final String TEXT_123 = " == null || dbschema_";
  protected final String TEXT_124 = ".trim().length() == 0) {" + NL + "                                        try(java.sql.Statement stmtSchema_";
  protected final String TEXT_125 = ".createStatement();" + NL + "                                            java.sql.ResultSet rsSchema_";
  protected final String TEXT_126 = " = stmtSchema_";
  protected final String TEXT_127 = ".executeQuery(\"select current_schema() \")) {" + NL + "                                            while(rsSchema_";
  protected final String TEXT_128 = ".next()){" + NL + "                                                defaultSchema_";
  protected final String TEXT_129 = " = rsSchema_";
  protected final String TEXT_130 = ".getString(\"current_schema\");" + NL + "                                            }" + NL + "                                        }" + NL + "                                    }" + NL + "                                    while(rsTable_";
  protected final String TEXT_131 = ") || ((dbschema_";
  protected final String TEXT_132 = " ==null || dbschema_";
  protected final String TEXT_133 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_134 = "(schema_";
  protected final String TEXT_135 = NL + "                                String tableForSearch_";
  protected final String TEXT_136 = " = ";
  protected final String TEXT_137 = ";" + NL + "                                if(tableForSearch_";
  protected final String TEXT_138 = " != null){" + NL + "                                    if(tableForSearch_";
  protected final String TEXT_139 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_140 = ".endsWith(\"\\\"\")){" + NL + "                                        tableForSearch_";
  protected final String TEXT_141 = " =  tableForSearch_";
  protected final String TEXT_142 = ".substring(1,tableForSearch_";
  protected final String TEXT_143 = ".length()-1);" + NL + "                                    }else{" + NL + "                                        tableForSearch_";
  protected final String TEXT_144 = ".toUpperCase();" + NL + "                                    }" + NL + "                                }" + NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  ...
  protected final String TEXT_147 = ".getTables(null, conn_";
  protected final String TEXT_148 = ".getSchema(), tableForSearch_";
  protected final String TEXT_149 = ", new String[]{\"TABLE\"})) {" + NL + "                                       if(rsTable_";
  protected final String TEXT_150 = " = true;" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_151 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_152 = ", null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_153 = ".next()) {" + NL + "                                        if(rsTable_";
  protected final String TEXT_154 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  protected final String TEXT_155 = ")) {" + NL + "                                            whetherExist_";
  protected final String TEXT_156 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }" + NL + "                            " + NL + "                            ";
  protected final String TEXT_157 = ".getTables(";
  protected final String TEXT_158 = ", null, null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_159 = ".next()) {" + NL + "                                        String table_";
  protected final String TEXT_160 = ".getString(\"TABLE_NAME\");" + NL + "                                        if(table_";
  protected final String TEXT_161 = ".equalsIgnoreCase(";
  protected final String TEXT_162 = ")) {" + NL + "                                            whetherExist_";
  protected final String TEXT_163 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_164 = ".getString(\"TABLE_NAME\");" + NL + "                                        if(table_";
  protected final String TEXT_165 = NL + "                                if(!whetherExist_";
  ...
  protected final String TEXT_172 = ") {" + NL + "                                    try (java.sql.Statement stmtDrop_";
  protected final String TEXT_173 = NL + "                                                      stmtDrop_";
  protected final String TEXT_174 = NL + "                                        stmtDrop_";
  protected final String TEXT_175 = NL + "                                    }";
  protected final String TEXT_176 = NL + "                                            conn_";
  protected final String TEXT_177 = NL + "                                }" + NL + "                                try(java.sql.Statement stmtCreate_";
  ...
  protected final String TEXT_183 = NL + "            try (java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_188 = NL + "            int rsTruncCountNumber_";
  protected final String TEXT_189 = " = 0;" + NL + "            try(java.sql.Statement stmtTruncCount_";
  protected final String TEXT_190 = NL + "                              stmtTruncCount_";
  protected final String TEXT_191 = NL + "                try (java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_192 = " = stmtTruncCount_";
  protected final String TEXT_193 = ".executeQuery(\"";
  protected final String TEXT_194 = "\")) {" + NL + "                    if(rsTruncCount_";
  protected final String TEXT_195 = ".next()) {" + NL + "                        rsTruncCountNumber_";
  protected final String TEXT_196 = " = rsTruncCount_";
  protected final String TEXT_197 = ".getInt(1);" + NL + "                    }" + NL + "                }" + NL + "            }" + NL + "            try (java.sql.Statement stmtTrunc_";
  protected final String TEXT_198 = NL + "                              stmtTrunc_";
  protected final String TEXT_199 = NL + "                conn_";
  protected final String TEXT_200 = NL + "                stmtTrunc_";
  protected final String TEXT_201 = NL + "                    if(!conn_";
  protected final String TEXT_202 = ".getAutoCommit()){" + NL + "                        conn_";
  protected final String TEXT_203 = ".commit();" + NL + "                    }";
  protected final String TEXT_204 = NL + "                deletedCount_";
  protected final String TEXT_205 = " += rsTruncCountNumber_";
  ...
  protected final String TEXT_213 = ".getInt(1);" + NL + "                }" + NL + "            }";
  protected final String TEXT_214 = NL + "\t\t\t\tString insert_";
  protected final String TEXT_215 = " = \"INSERT INTO \\\"\" + tableName_";
  protected final String TEXT_216 = " + \"\\\" (";
  protected final String TEXT_217 = ", \"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_218 = "\")+\") VALUES (";
  protected final String TEXT_219 = ", \"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_220 = ")+\")\";";
  protected final String TEXT_221 = " + \"\\\" (\"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_222 = "\")+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_223 = NL + "    pstmt_";
  protected final String TEXT_224 = ".prepareStatement(insert_";
  protected final String TEXT_225 = ");" + NL + "    resourceMap.put(\"pstmt_";
  protected final String TEXT_226 = "\", pstmt_";
  protected final String TEXT_227 = " = null;" + NL + "    String keyPsmt_";
  protected final String TEXT_228 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_229 = " + \"]\";" + NL + "    if(GlobalResource.resourceMap.get(keyPsmt_";
  protected final String TEXT_230 = ")== null){" + NL + "        pstmt_";
  protected final String TEXT_231 = ");" + NL + "        resourceMap.put(\"pstmt_";
  protected final String TEXT_232 = ");" + NL + "        GlobalResource.resourceMap.put(keyPsmt_";
  protected final String TEXT_233 = ", pstmt_";
  protected final String TEXT_234 = ");" + NL + "    }else{" + NL + "        pstmt_";
  protected final String TEXT_235 = " = (java.sql.PreparedStatement)GlobalResource.resourceMap.get(keyPsmt_";
  protected final String TEXT_236 = ");" + NL + "    }";
  protected final String TEXT_237 = NL + "\t\t\t\tString update_";
  protected final String TEXT_238 = " = \"UPDATE \\\"\" + tableName_";
  protected final String TEXT_239 = " + \"\\\" SET ";
  protected final String TEXT_240 = ", \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_241 = "\")+\" WHERE ";
  protected final String TEXT_242 = "\";";
  protected final String TEXT_243 = " + \"\\\" SET \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_244 = NL + "\t    pstmt_";
  protected final String TEXT_245 = ".prepareStatement(update_";
  protected final String TEXT_246 = ");" + NL + "\t    resourceMap.put(\"pstmt_";
  protected final String TEXT_247 = ");" + NL + "\t    ";
  protected final String TEXT_248 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + tableName_";
  protected final String TEXT_249 = " + \"\\\" WHERE ";
  protected final String TEXT_250 = "\");" + NL + "\t    resourceMap.put(\"pstmt_";
  protected final String TEXT_251 = ");" + NL + "\t    pstmtInsert_";
  protected final String TEXT_252 = ");" + NL + "\t    resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_253 = "\", pstmtInsert_";
  protected final String TEXT_254 = ");" + NL + "\t    pstmtUpdate_";
  protected final String TEXT_255 = ");" + NL + "\t    resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_256 = "\", pstmtUpdate_";
  protected final String TEXT_257 = NL + "\t    pstmtUpdate_";
  protected final String TEXT_258 = NL + "\t    String delete_";
  protected final String TEXT_259 = " = \"DELETE FROM \\\"\" + tableName_";
  protected final String TEXT_260 = "\";" + NL + "\t    pstmt_";
  protected final String TEXT_261 = ".prepareStatement(delete_";
  protected final String TEXT_262 = NL + "       \t";
  protected final String TEXT_263 = NL + "\t\t \tinsertSQLSplits_";
  protected final String TEXT_264 = " = insert_";
  protected final String TEXT_265 = ".split(\"\\\\?\");";
  protected final String TEXT_266 = NL + "\t\t\tupdate_";
  protected final String TEXT_267 = " += \" \";" + NL + "\t    \tupdateSQLSplits_";
  protected final String TEXT_268 = " = update_";
  protected final String TEXT_269 = " += \" \";" + NL + "\t\t\tupdateSQLSplits_";
  protected final String TEXT_270 = ".split(\"\\\\?\");" + NL + "\t\t\tinsertSQLSplits_";
  protected final String TEXT_271 = NL + "\t\t\tdelete_";
  protected final String TEXT_272 = " += \" \";" + NL + "\t\t   \tdeleteSQLSplits_";
  protected final String TEXT_273 = " = delete_";
  protected final String TEXT_274 = NL + "\t\t\treplace_";
  protected final String TEXT_275 = " += \" \";" + NL + "\t\t\treplaceSQLSplits_";
  protected final String TEXT_276 = " = replace_";
  protected final String TEXT_277 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_278 = " += \" \";" + NL + "\t\t\tinsertIgnoreSQLSplits_";
  protected final String TEXT_279 = " = insertIgnore_";
  protected final String TEXT_280 = NL + "\t\t}" + NL + "\t";
  protected final String TEXT_281 = NL + "\t\t\t\tcommitEvery_";
  protected final String TEXT_282 = " = buffersSize_";
  protected final String TEXT_283 = ";";
  protected final String TEXT_284 = NL + "\t\t\t\tbatchSize_";
  protected final String TEXT_285 = NL + "        whetherReject_";
  protected final String TEXT_286 = " = false;";
  protected final String TEXT_287 = NL + "                        query_";
  protected final String TEXT_288 = NL + "                            geometryColumnName_";
  protected final String TEXT_289 = " = \"";
  protected final String TEXT_290 = "\";" + NL + "                            if (firstGeometry_";
  protected final String TEXT_291 = ") {" + NL + "                                dimension_";
  protected final String TEXT_292 = " = 2;" + NL + "" + NL + "                                // A null first geometry will lead to unknown coordinate system" + NL + "                                if (";
  protected final String TEXT_293 = " == null) {" + NL + "                            \t    SRID_";
  protected final String TEXT_294 = " = -1;" + NL + "                                } else {" + NL + "                                    org.opengis.referencing.crs.CoordinateReferenceSystem refSys_";
  protected final String TEXT_295 = " =" + NL + "                                        ((org.talend.sdi.geometry.Geometry) ";
  protected final String TEXT_296 = ").getCRS();" + NL + "                                    if (refSys_";
  protected final String TEXT_297 = " != null) {" + NL + "                                        dimension_";
  protected final String TEXT_298 = " = refSys_";
  protected final String TEXT_299 = ".getCoordinateSystem().getDimension();" + NL + "                                        try {" + NL + "                                            java.util.Set ident_";
  protected final String TEXT_300 = ".getIdentifiers();" + NL + "                                            if ((ident_";
  protected final String TEXT_301 = " == null || ident_";
  protected final String TEXT_302 = ".isEmpty())" + NL + "                                                && refSys_";
  protected final String TEXT_303 = " == org.geotools.referencing.crs.DefaultGeographicCRS.WGS84) {" + NL + "                                                SRID_";
  protected final String TEXT_304 = " = 4326;" + NL + "                                            } else {" + NL + "                                                String code_";
  protected final String TEXT_305 = " = ((org.geotools.referencing.NamedIdentifier) ident_";
  protected final String TEXT_306 = ".toArray()[0]).getCode();" + NL + "                                                SRID_";
  protected final String TEXT_307 = " = Integer.parseInt(code_";
  protected final String TEXT_308 = ");" + NL + "                                            }" + NL + "                                        } catch (java.lang.Exception e) {" + NL + "                                            String SRIDError_";
  protected final String TEXT_309 = " = \"SRID_";
  protected final String TEXT_310 = " could not be determined\";";
  protected final String TEXT_311 = NL + "                                            System.out.println(SRIDError_";
  protected final String TEXT_312 = ");" + NL + "                                            SRID_";
  protected final String TEXT_313 = " = -1;" + NL + "                                        }" + NL + "                                     }  else {" + NL + "                                        SRID_";
  protected final String TEXT_314 = " = -1;" + NL + "                                     }" + NL + "                                     firstGeometry_";
  protected final String TEXT_315 = " = false;" + NL + "                                 }" + NL + "                            }";
  protected final String TEXT_316 = NL + "\t\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_317 = ",";
  protected final String TEXT_318 = ", ";
  protected final String TEXT_319 = ",insertSQLSplits_";
  protected final String TEXT_320 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_321 = NL + "\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_322 = "\");" + NL + "\t\t\t\t";
  protected final String TEXT_323 = NL + "                globalMap.put(\"";
  protected final String TEXT_324 = "_QUERY\", query_";
  protected final String TEXT_325 = ".toString().trim());";
  protected final String TEXT_326 = NL + "\t\t\t";
  protected final String TEXT_327 = NL + "    \t\tpstmt_";
  protected final String TEXT_328 = ".addBatch();" + NL + "    \t\tnb_line_";
  protected final String TEXT_329 = "++;" + NL + "    \t\t  ";
  protected final String TEXT_330 = NL + "    \t\t  batchSizeCounter_";
  protected final String TEXT_331 = NL + "            try {" + NL + "                nb_line_";
  protected final String TEXT_332 = "++;" + NL + "\t\t\t\t";
  protected final String TEXT_333 = NL + "                \tsp_";
  protected final String TEXT_334 = ".setSavepoint();" + NL + "\t\t\t\t";
  protected final String TEXT_335 = NL + "                insertedCount_";
  protected final String TEXT_336 = " = insertedCount_";
  ...
  protected final String TEXT_341 = ".releaseSavepoint(sp_";
  protected final String TEXT_342 = ");" + NL + "\t\t\t\t";
  protected final String TEXT_343 = NL + "            } catch(java.lang.Exception e) {" + NL + "\t\t\t\t";
  protected final String TEXT_344 = ".rollback(sp_";
  protected final String TEXT_345 = ");" + NL + "\t            ";
  protected final String TEXT_346 = NL + "                whetherReject_";
  ...
  protected final String TEXT_351 = NL + "                        rejectedCount_";
  protected final String TEXT_352 = " = rejectedCount_";
  protected final String TEXT_353 = " + 1;";
  protected final String TEXT_354 = ".errorCode = ((java.sql.SQLException)e).getSQLState();";
  protected final String TEXT_355 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_356 = NL + "                        System.err.print(e.getMessage());";
  protected final String TEXT_357 = NL + "            }";
  protected final String TEXT_358 = NL + "                    routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_359 = ",updateSQLSplits_";
  protected final String TEXT_360 = NL + "\t\t\t\t\tint count_";
  protected final String TEXT_361 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_362 = NL + "\t\t\t\t\t   ";
  protected final String TEXT_363 = NL + "\t\t\t\t\t";
  protected final String TEXT_364 = NL + "\t\t\t\t\t\t\tquery_";
  protected final String TEXT_365 = ";" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_366 = NL + "\t\t\t\t   query_";
  protected final String TEXT_367 = ";" + NL + "\t\t\t    ";
  protected final String TEXT_368 = NL + "\t                sp_";
  protected final String TEXT_369 = ".setSavepoint();" + NL + "\t            ";
  protected final String TEXT_370 = NL + "                updatedCount_";
  protected final String TEXT_371 = " = updatedCount_";
  protected final String TEXT_372 = NL + "                \tconn_";
  protected final String TEXT_373 = NL + "                    \t";
  protected final String TEXT_374 = NL + "            int checkCount_";
  protected final String TEXT_375 = " = -1;" + NL + "            try (java.sql.ResultSet rs_";
  protected final String TEXT_376 = " = pstmt_";
  protected final String TEXT_377 = ".executeQuery()) {" + NL + "                while(rs_";
  protected final String TEXT_378 = ".next()) {" + NL + "                    checkCount_";
  protected final String TEXT_379 = " = rs_";
  protected final String TEXT_380 = ".getInt(1);" + NL + "                }" + NL + "            }" + NL + "            if(checkCount_";
  protected final String TEXT_381 = " > 0) {";
  protected final String TEXT_382 = NL + "                            query_";
  protected final String TEXT_383 = NL + NL + "\t\t\t\t\t\tint count_";
  protected final String TEXT_384 = ", pstmtUpdate_";
  protected final String TEXT_385 = "\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_386 = NL + "\t\t\t\t\t\t\t\tquery_";
  protected final String TEXT_387 = ";" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_388 = ";" + NL + "\t\t\t\t    \t";
  protected final String TEXT_389 = NL + "                    globalMap.put(\"";
  protected final String TEXT_390 = NL + "                try {" + NL + "\t\t\t\t\t";
  protected final String TEXT_391 = NL + "\t                    sp_";
  protected final String TEXT_392 = ".setSavepoint();" + NL + "\t                ";
  protected final String TEXT_393 = NL + "                    updatedCount_";
  protected final String TEXT_394 = " + pstmtUpdate_";
  protected final String TEXT_395 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_396 = "++;";
  protected final String TEXT_397 = NL + "    \t                conn_";
  protected final String TEXT_398 = ");" + NL + "    \t            ";
  protected final String TEXT_399 = NL + "                } catch(java.lang.Exception e) {" + NL + "\t\t\t\t\t";
  protected final String TEXT_400 = NL + "                    whetherReject_";
  protected final String TEXT_401 = NL + "                        throw(e);";
  protected final String TEXT_402 = NL + "                        nb_line_";
  protected final String TEXT_403 = NL + "                                ";
  protected final String TEXT_404 = NL + "                            rejectedCount_";
  protected final String TEXT_405 = NL + "                            System.err.print(e.getMessage());";
  protected final String TEXT_406 = NL + "                }" + NL + "            } else {";
  protected final String TEXT_407 = NL + "\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_408 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_409 = NL + "\t\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_410 = ", pstmtInsert_";
  protected final String TEXT_411 = NL + "                    insertedCount_";
  protected final String TEXT_412 = " + pstmtInsert_";
  protected final String TEXT_413 = NL + "                }" + NL + "            }";
  protected final String TEXT_414 = NL + "            int updateFlag_";
  protected final String TEXT_415 = "=0;";
  protected final String TEXT_416 = NL + NL + "\t\t\t\t\tint count_";
  protected final String TEXT_417 = NL + "    \t\t\t\t\t";
  protected final String TEXT_418 = NL + "\t\t\t\t\t\tquery_";
  protected final String TEXT_419 = ";" + NL + "\t\t\t\t\t";
  protected final String TEXT_420 = NL + NL + "            try {" + NL + "\t\t\t\t";
  protected final String TEXT_421 = NL + "                updateFlag_";
  protected final String TEXT_422 = "=pstmtUpdate_";
  protected final String TEXT_423 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_424 = "+updateFlag_";
  protected final String TEXT_425 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_426 = NL + "            if(updateFlag_";
  protected final String TEXT_427 = " == 0) {" + NL + "            \t";
  protected final String TEXT_428 = NL + "\t\t\t\tquery_";
  protected final String TEXT_429 = " = new StringBuffer(\"\");" + NL + "        \t\t";
  protected final String TEXT_430 = ");" + NL + "\t                \t\t\t";
  protected final String TEXT_431 = NL + "    \t            }else{" + NL + "    \t\t\t\t\tnb_line_";
  protected final String TEXT_432 = "++;" + NL + "     \t\t\t\t\t";
  protected final String TEXT_433 = NL + "    \t\t\t\t}" + NL + "                } catch(java.lang.Exception e) {" + NL + "\t\t\t\t\t";
  protected final String TEXT_434 = NL + "                }";
  protected final String TEXT_435 = NL + "\t                        query_";
  protected final String TEXT_436 = ";" + NL + "\t                        ";
  protected final String TEXT_437 = ".addBatch();" + NL + "\t\t\tnb_line_";
  protected final String TEXT_438 = "++;" + NL + "    \t\t";
  protected final String TEXT_439 = NL + "            try {" + NL + "\t\t\t\t";
  protected final String TEXT_440 = NL + "                deletedCount_";
  protected final String TEXT_441 = " = deletedCount_";
  protected final String TEXT_442 = ".executeUpdate();" + NL + "                nb_line_";
  protected final String TEXT_443 = NL + "                    nb_line_";
  protected final String TEXT_444 = NL + "            if(!whetherReject_";
  protected final String TEXT_445 = ") {";
  protected final String TEXT_446 = NL + "    \t\t\tif ((batchSize_";
  protected final String TEXT_447 = " > 0) && (batchSize_";
  protected final String TEXT_448 = " <= batchSizeCounter_";
  protected final String TEXT_449 = ")) {" + NL + "                try {" + NL + "\t\t\t\t\t\tint countSum_";
  protected final String TEXT_450 = " = 0;" + NL + "\t\t\t\t\t\t    ";
  protected final String TEXT_451 = NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_452 = ": pstmt_";
  protected final String TEXT_453 = ".executeBatch()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_454 = " += (countEach_";
  protected final String TEXT_455 = " < 0 ? 0 : countEach_";
  protected final String TEXT_456 = ");" + NL + "\t\t\t\t\t\t}";
  protected final String TEXT_457 = NL + "\t\t\t\t    \t";
  protected final String TEXT_458 = NL + "\t\t\t\t    \t\tinsertedCount_";
  protected final String TEXT_459 = " += countSum_";
  protected final String TEXT_460 = NL + "\t\t\t\t    \t\tupdatedCount_";
  protected final String TEXT_461 = NL + "\t\t\t\t    \t    deletedCount_";
  protected final String TEXT_462 = NL + "            \t    \tbatchSizeCounter_";
  protected final String TEXT_463 = " = 0;" + NL + "                }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_464 = "){" + NL + "\t\t\t\t    \tjava.sql.SQLException ne_";
  protected final String TEXT_465 = " = e_";
  protected final String TEXT_466 = ".getNextException(),sqle_";
  protected final String TEXT_467 = "=null;" + NL + "\t\t\t\t    \tString errormessage_";
  protected final String TEXT_468 = ";" + NL + "\t\t\t\t\t\tif (ne_";
  protected final String TEXT_469 = " != null) {" + NL + "\t\t\t\t\t\t\t// build new exception to provide the original cause" + NL + "\t\t\t\t\t\t\tsqle_";
  protected final String TEXT_470 = " = new java.sql.SQLException(e_";
  protected final String TEXT_471 = ".getMessage() + \"\\ncaused by: \" + ne_";
  protected final String TEXT_472 = ".getMessage(), ne_";
  protected final String TEXT_473 = ".getSQLState(), ne_";
  protected final String TEXT_474 = ".getErrorCode(), ne_";
  protected final String TEXT_475 = ");" + NL + "\t\t\t\t\t\t\terrormessage_";
  protected final String TEXT_476 = " = sqle_";
  protected final String TEXT_477 = ".getMessage();" + NL + "\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\terrormessage_";
  protected final String TEXT_478 = ".getMessage();" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t    \t";
  protected final String TEXT_479 = NL + "\t\t\t\t    \t\tif (ne_";
  protected final String TEXT_480 = " != null) {" + NL + "\t\t\t\t    \t\t\tthrow(sqle_";
  protected final String TEXT_481 = ");" + NL + "\t\t\t\t    \t\t}else{" + NL + "\t\t\t\t            \tthrow(e_";
  protected final String TEXT_482 = ");" + NL + "\t\t\t\t            }" + NL + "\t\t\t\t    \t";
  protected final String TEXT_483 = NL + "\t\t\t\t    \tint countSum_";
  protected final String TEXT_484 = " = 0;" + NL + "\t\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_485 = ": e_";
  protected final String TEXT_486 = ".getUpdateCounts()) {" + NL + "\t\t\t\t\t\t\tcountSum_";
  protected final String TEXT_487 = ");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_488 = NL + "\t\t\t\t    \tSystem.err.println(errormessage_";
  protected final String TEXT_489 = ");" + NL + "\t\t\t\t    \t";
  protected final String TEXT_490 = NL + "\t\t\t\t\t}" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_491 = NL + "    \t\t    commitCounter_";
  protected final String TEXT_492 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_493 = " <= commitCounter_";
  protected final String TEXT_494 = NL + "                if ((batchSize_";
  protected final String TEXT_495 = " > 0) && (batchSizeCounter_";
  protected final String TEXT_496 = " > 0)) {" + NL + "                try {" + NL + "                \t\tint countSum_";
  protected final String TEXT_497 = " = 0;" + NL + "                \t\t    ";
  protected final String TEXT_498 = NL + "            \t    \t";
  protected final String TEXT_499 = NL + "            \t    \t\tinsertedCount_";
  protected final String TEXT_500 = ";" + NL + "            \t    \t";
  protected final String TEXT_501 = NL + "            \t    \t\tupdatedCount_";
  protected final String TEXT_502 = NL + "            \t    \t    deletedCount_";
  protected final String TEXT_503 = NL + "                batchSizeCounter_";
  protected final String TEXT_504 = " = 0;" + NL + "               }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_505 = "){" + NL + "\t\t\t    \tjava.sql.SQLException ne_";
  protected final String TEXT_506 = "=null;" + NL + "\t\t\t    \tString errormessage_";
  protected final String TEXT_507 = ";" + NL + "\t\t\t\t\tif (ne_";
  protected final String TEXT_508 = " != null) {" + NL + "\t\t\t\t\t\t// build new exception to provide the original cause" + NL + "\t\t\t\t\t\tsqle_";
  protected final String TEXT_509 = ");" + NL + "\t\t\t\t\t\terrormessage_";
  protected final String TEXT_510 = ".getMessage();" + NL + "\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\terrormessage_";
  protected final String TEXT_511 = ".getMessage();" + NL + "\t\t\t\t\t}" + NL + "\t\t\t    \t";
  protected final String TEXT_512 = NL + "\t\t\t    \t\tif (ne_";
  protected final String TEXT_513 = " != null) {" + NL + "\t\t\t    \t\t\tthrow(sqle_";
  protected final String TEXT_514 = ");" + NL + "\t\t\t    \t\t}else{" + NL + "\t\t\t            \tthrow(e_";
  protected final String TEXT_515 = ");" + NL + "\t\t\t            }" + NL + "\t\t\t    \t";
  protected final String TEXT_516 = NL + "\t\t\t    \tint countSum_";
  protected final String TEXT_517 = " = 0;" + NL + "\t\t\t\t\tfor(int countEach_";
  protected final String TEXT_518 = ".getUpdateCounts()) {" + NL + "\t\t\t\t\t\tcountSum_";
  protected final String TEXT_519 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_520 = NL + "\t\t\t    \t\tinsertedCount_";
  protected final String TEXT_521 = ";" + NL + "\t\t\t    \t";
  protected final String TEXT_522 = NL + "\t\t\t    \t\tupdatedCount_";
  protected final String TEXT_523 = NL + "\t\t\t    \t    deletedCount_";
  protected final String TEXT_524 = NL + "\t\t\t    \tSystem.err.println(errormessage_";
  protected final String TEXT_525 = ");" + NL + "\t\t\t    \t";
  protected final String TEXT_526 = NL + "\t\t\t\t}" + NL + "            }";
  protected final String TEXT_527 = ".commit();" + NL + "                \t";
  protected final String TEXT_528 = NL + "                \tcommitCounter_";
  protected final String TEXT_529 = "=0;" + NL + "                }";
