...
public class TSQLiteCommitMainJava
{
  ...
  protected final String TEXT_57 = "\");" + NL + "\tif(conn_";
  protected final String TEXT_58 = " != null && !conn_";
  protected final String TEXT_59 = ".isClosed())" + NL + "\t{" + NL + "\t";
  protected final String TEXT_60 = NL + "\t\ttry{" + NL + "\t";
  protected final String TEXT_61 = NL + "\t\t\t";
  protected final String TEXT_62 = NL + "\t";
  protected final String TEXT_63 = NL + "\t\t}finally{" + NL + "\t\t\t";
