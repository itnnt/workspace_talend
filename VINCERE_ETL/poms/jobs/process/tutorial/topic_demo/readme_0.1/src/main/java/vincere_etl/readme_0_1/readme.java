...
package vincere_etl.readme_0_1;
...
/**
 * Job: readme Purpose: <br>
 * Description: <br>
 * 
 * @author ocarbone@talend.com
 * @version 7.2.1.20190620_1446
 * @status
 */
public class readme implements TalendJob {
	...
	private final String jobName = "readme";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(readme.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tMsgBox_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String messagetMsgBox_1 = "Want to talk about Talend Open Studio?" + "\n Need help to use the software?"
						+ "\n Want to make suggestions and discuss with the dev team?"
						+ "\n\n http://www.talendforge.org/forum/ is the right place!";
	...
	public static void main(String[] args) {
		final readme readmeClass = new readme();

		int exitCode = readmeClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = readme.class.getClassLoader()
					.getResourceAsStream("vincere_etl/readme_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = readme.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : readme");
		}
...
/************************************************************************************************
 * 24224 characters generated by Talend Open Studio for Data Integration on the
 * August 30, 2019 at 1:43:28 PM ICT
 ************************************************************************************************/