...
public class THSQLDbOutputEndJava
{
  ...
  protected final String TEXT_35 = NL + "    if (commitCounter_";
  protected final String TEXT_36 = " > 0) {";
  protected final String TEXT_37 = NL + "        conn_";
  protected final String TEXT_38 = ".commit();";
  protected final String TEXT_39 = NL + "    }";
  protected final String TEXT_40 = NL + "        if(pstmtUpdate_";
  protected final String TEXT_41 = " != null){" + NL + "            pstmtUpdate_";
  protected final String TEXT_42 = ".close();" + NL + "            resourceMap.remove(\"pstmtUpdate_";
  protected final String TEXT_43 = "\");" + NL + "        }" + NL + "        if(pstmtInsert_";
  protected final String TEXT_44 = " != null){" + NL + "            pstmtInsert_";
  protected final String TEXT_45 = ".close();" + NL + "            resourceMap.remove(\"pstmtInsert_";
  protected final String TEXT_46 = "\");" + NL + "        }" + NL + "        if(pstmt_";
  protected final String TEXT_47 = " != null) {" + NL + "            pstmt_";
  protected final String TEXT_48 = ".close();" + NL + "            resourceMap.remove(\"pstmt_";
  protected final String TEXT_49 = "\");" + NL + "        }";
  protected final String TEXT_50 = NL + "        if(pstmt_";
  protected final String TEXT_51 = NL + "    resourceMap.put(\"statementClosed_";
  protected final String TEXT_52 = "\", true);";
  protected final String TEXT_53 = NL + "\tconn_";
  protected final String TEXT_54 = " .close();" + NL + "\t";
  protected final String TEXT_55 = NL + "\tresourceMap.put(\"finish_";
  protected final String TEXT_56 = "\", true);" + NL + "\t";
  protected final String TEXT_57 = NL + "\tnb_line_deleted_";
  ...
  protected final String TEXT_79 = "_NB_LINE_UPDATED\",(Integer)globalMap.get(\"";
  protected final String TEXT_80 = "_NB_LINE_UPDATED\") + nb_line_update_";
  protected final String TEXT_81 = "_NB_LINE_INSERTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_82 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_83 = "_NB_LINE_INSERTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_84 = "_NB_LINE_INSERTED\") + nb_line_inserted_";
  protected final String TEXT_85 = "_NB_LINE_DELETED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_86 = "_NB_LINE_DELETED\",nb_line_deleted_";
  protected final String TEXT_87 = "_NB_LINE_DELETED\",(Integer)globalMap.get(\"";
