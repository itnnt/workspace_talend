...
public class TSQLiteOutputBeginJava {
  ...
  protected final String TEXT_35 = NL + NL + "int nb_line_";
  ...
  protected final String TEXT_49 = "=0;" + NL + "       int tmp_batchUpdateCount_";
  ...
  protected final String TEXT_65 = " = \"jdbc:sqlite:\"+ \"/\" + ";
  protected final String TEXT_66 = ";" + NL + "    \t";
  protected final String TEXT_67 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_68 = NL + "\tresourceMap.put(\"conn_";
  ...
  protected final String TEXT_72 = ";" + NL + "        int commitCounter_";
  protected final String TEXT_73 = NL + "            try (java.sql.Statement stmtDrop_";
  protected final String TEXT_74 = " = conn_";
  protected final String TEXT_75 = ".createStatement();" + NL + "                    java.sql.Statement stmtCreate_";
  protected final String TEXT_76 = ".createStatement()) {";
  protected final String TEXT_77 = NL + "                stmtDrop_";
  ...
  protected final String TEXT_83 = NL + "            java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_84 = ".getMetaData();" + NL + "            boolean whetherExist_";
  protected final String TEXT_85 = " = false;" + NL + "            try (java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_93 = " = true;" + NL + "                        break;" + NL + "                    }" + NL + "                }" + NL + "            }";
  ...
  protected final String TEXT_99 = ") {" + NL + "                    try (java.sql.Statement stmtDrop_";
  protected final String TEXT_100 = NL + "                        stmtDrop_";
  protected final String TEXT_101 = NL + "                    }" + NL + "                }" + NL + "                try (java.sql.Statement stmtCreate_";
  protected final String TEXT_102 = NL + "                    stmtCreate_";
  protected final String TEXT_103 = NL + "                }";
  protected final String TEXT_104 = NL + "            try (java.sql.Statement stmtClear_";
  protected final String TEXT_105 = NL + "                deletedCount_";
  protected final String TEXT_106 = " = deletedCount_";
  protected final String TEXT_107 = " + stmtClear_";
  ...
  protected final String TEXT_114 = ".prepareStatement(insert_";
  protected final String TEXT_115 = ");" + NL + "\t    resourceMap.put(\"pstmt_";
  protected final String TEXT_116 = "\", pstmt_";
  protected final String TEXT_117 = ");" + NL + "\t    ";
  protected final String TEXT_118 = NL + "\t    String update_";
  protected final String TEXT_119 = " = \"UPDATE \\\"\" + ";
  protected final String TEXT_120 = " + \"\\\" SET ";
  protected final String TEXT_121 = " WHERE ";
  protected final String TEXT_122 = "\";" + NL + "\t    java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_125 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + ";
  protected final String TEXT_126 = " + \"\\\" WHERE ";
  protected final String TEXT_127 = "\");" + NL + "\t    resourceMap.put(\"pstmt_";
  protected final String TEXT_128 = ");" + NL + "\t    String insert_";
  protected final String TEXT_129 = ")\";" + NL + "\t    java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_130 = ");" + NL + "\t    resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_131 = "\", pstmtInsert_";
  protected final String TEXT_132 = ");" + NL + "\t    String update_";
  protected final String TEXT_133 = "\";" + NL + "\t    java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_134 = ");" + NL + "\t    resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_135 = "\", pstmtUpdate_";
  protected final String TEXT_136 = NL + "\t    String delete_";
  protected final String TEXT_137 = " = \"DELETE FROM \\\"\" + ";
  protected final String TEXT_138 = ".prepareStatement(delete_";
  protected final String TEXT_139 = NL + "        StringBuffer query_";
  protected final String TEXT_140 = " = null;" + NL + "       \t";
  protected final String TEXT_141 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_142 = " = insert_";
  protected final String TEXT_143 = ".split(\"\\\\?\");";
  protected final String TEXT_144 = NL + "\t\t\tupdate_";
  protected final String TEXT_145 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_146 = " = update_";
  protected final String TEXT_147 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_148 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_149 = NL + "\t\t\tdelete_";
  protected final String TEXT_150 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_151 = " = delete_";
  protected final String TEXT_152 = NL + "\t\t\treplace_";
  protected final String TEXT_153 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_154 = " = replace_";
  protected final String TEXT_155 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_156 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_157 = " = insertIgnore_";
