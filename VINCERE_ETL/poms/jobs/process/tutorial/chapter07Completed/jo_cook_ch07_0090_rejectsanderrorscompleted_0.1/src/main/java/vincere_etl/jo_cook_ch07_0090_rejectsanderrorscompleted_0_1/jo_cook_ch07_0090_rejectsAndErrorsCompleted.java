...
package vincere_etl.jo_cook_ch07_0090_rejectsanderrorscompleted_0_1;
...
/**
 * Job: jo_cook_ch07_0090_rejectsAndErrorsCompleted Purpose: Cookbook:
 * demonstrate capturing rejects and errors on output<br>
 ...
 * @status
 */
public class jo_cook_ch07_0090_rejectsAndErrorsCompleted implements TalendJob {
	...
	private final String jobName = "jo_cook_ch07_0090_rejectsAndErrorsCompleted";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					jo_cook_ch07_0090_rejectsAndErrorsCompleted.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(jo_cook_ch07_0090_rejectsAndErrorsCompleted.this,
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		final static byte[] commonByteArrayLock_VINCERE_ETL_jo_cook_ch07_0090_rejectsAndErrorsCompleted = new byte[0];
		static byte[] commonByteArray_VINCERE_ETL_jo_cook_ch07_0090_rejectsAndErrorsCompleted = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_VINCERE_ETL_jo_cook_ch07_0090_rejectsAndErrorsCompleted.length) {
					if (length < 1024
							&& commonByteArray_VINCERE_ETL_jo_cook_ch07_0090_rejectsAndErrorsCompleted.length == 0) {
						commonByteArray_VINCERE_ETL_jo_cook_ch07_0090_rejectsAndErrorsCompleted = new byte[1024];
					} else {
						commonByteArray_VINCERE_ETL_jo_cook_ch07_0090_rejectsAndErrorsCompleted = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_VINCERE_ETL_jo_cook_ch07_0090_rejectsAndErrorsCompleted, 0, length);
				strReturn = new String(commonByteArray_VINCERE_ETL_jo_cook_ch07_0090_rejectsAndErrorsCompleted, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_VINCERE_ETL_jo_cook_ch07_0090_rejectsAndErrorsCompleted) {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				class Util_tLogRow_1 {
					...
					public String print(String[] row, int nbLine) {
						...
						for (int i = 0; i < titleWidth - "customerId".length() + 1; i++)
							sb.append(" ");
						sb.append("| " + row[0]);
						...
						for (int i = 0; i < titleWidth - "countryOfResidence".length() + 1; i++)
							sb.append(" ");
						sb.append("| " + row[2]);
...
///////////////////////    			
				...
				String tableName_tMysqlOutput_1 = "customer_reject_test";
				...
				String dbProperties_tMysqlOutput_1 = context.cookbookDBCompleted_AdditionalParams;
				String url_tMysqlOutput_1 = null;
				if (dbProperties_tMysqlOutput_1 == null || dbProperties_tMysqlOutput_1.trim().length() == 0) {
					url_tMysqlOutput_1 = "jdbc:mysql://" + context.cookbookDBCompleted_Server + ":"
							+ context.cookbookDBCompleted_Port + "/" + context.cookbookDBCompleted_Database + "?"
							+ "rewriteBatchedStatements=true";
				} else {
					String properties_tMysqlOutput_1 = context.cookbookDBCompleted_AdditionalParams;
				...
				String dbUser_tMysqlOutput_1 = context.cookbookDBCompleted_Login;

				final String decryptedPassword_tMysqlOutput_1 = context.cookbookDBCompleted_Password;
				...
				try (java.sql.ResultSet rsTable_tMysqlOutput_1 = dbMetaData_tMysqlOutput_1
					...
					while (rsTable_tMysqlOutput_1.next()) {
						...
						if (table_tMysqlOutput_1.equalsIgnoreCase("customer_reject_test")) {
				...
				String insert_tMysqlOutput_1 = "INSERT INTO `" + "customer_reject_test"
...
// Start of branch "row1"
						if (row1 != null) {
							...
							pstmt_tMysqlOutput_1.setInt(1, row1.customerId);

							if (row1.name == null) {
								pstmt_tMysqlOutput_1.setNull(2, java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_1.setString(2, row1.name);
							}

							if (row1.countryOfResidence == null) {
								pstmt_tMysqlOutput_1.setNull(3, java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_1.setString(3, row1.countryOfResidence);
							}
							...
							try {
								...
								row2.errorMessage = e.getMessage() + " - Line: " + tos_count_tMysqlOutput_1;
							}
...
///////////////////////		
								...
								row_tLogRow_1[0] = String.valueOf(row2.customerId);
								...
								if (row2.countryOfResidence != null) { //
									row_tLogRow_1[2] = String.valueOf(row2.countryOfResidence);

								} //

								if (row2.errorCode != null) { //
									row_tLogRow_1[3] = String.valueOf(row2.errorCode);

								} //

								if (row2.errorMessage != null) { //
									row_tLogRow_1[4] = String.valueOf(row2.errorMessage);
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final jo_cook_ch07_0090_rejectsAndErrorsCompleted jo_cook_ch07_0090_rejectsAndErrorsCompletedClass = new jo_cook_ch07_0090_rejectsAndErrorsCompleted();

		int exitCode = jo_cook_ch07_0090_rejectsAndErrorsCompletedClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = jo_cook_ch07_0090_rejectsAndErrorsCompleted.class.getClassLoader()
					.getResourceAsStream("vincere_etl/jo_cook_ch07_0090_rejectsanderrorscompleted_0_1/contexts/"
							+ contextStr + ".properties");
			if (inContext == null) {
				inContext = jo_cook_ch07_0090_rejectsAndErrorsCompleted.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : jo_cook_ch07_0090_rejectsAndErrorsCompleted");
		}
...
/************************************************************************************************
 * 65706 characters generated by Talend Open Studio for Data Integration on the
 * August 30, 2019 at 4:03:15 PM ICT
 ************************************************************************************************/