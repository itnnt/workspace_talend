...
public class CompanyOutputOutputTest {
    ...
    public void map() throws IOException {
        ...
        final CompanyOutputOutputConfiguration configuration =  new CompanyOutputOutputConfiguration()
                                                                                /* .setDataset() */;

        // We create the component processor instance using the configuration filled above
        final Processor processor = COMPONENT_FACTORY.createProcessor(CompanyOutputOutput.class, configuration);
